...
config.Toolbars = [
	...
	["TBHandle", "Cut", "Copy", "Paste", "PasteText", "FindReplace", "Delete", "RemoveFormat", "TBSep", "UnDo", "ReDo", "SelectAll", "UnSelect", "TBSep", "OrderedList", "UnOrderedList", "Indent", "Outdent", "ParagraphAttr", "TBSep", "ForeColor", "BackColor", "BgColor", "BackImage", "TBSep", "RemoteUpload", "LocalUpload", "ImportExcel"],
	["TBHandle", "Media", "File", "GalleryMenu", "TBSep", "FormMenu", "TBSep", "Fieldset", "Iframe", "HorizontalRule", "Marquee", "CreateLink", "Unlink", "Map", "Anchor", "TBSep", "Template", "Symbol", "Emot", "Excel", "Quote", "ShowBorders", "TBSep", "Maximize", "About"]
];
