...
enum EGameEventCode : int {
  ...
  PANUMA_BAG_FULL = 521,
  PANUMA_BAG_FULL_CREATE = 522,
  PANUMA_BAG_FULL_REWARD = 523,
...
enum EGameMsgID : int {
  ...
  REQ_WORLD_DEL_MAIL_FROM_PLAYER = 1901,
  ACK_WORLD_DEL_MAIL_FROM_PLAYER = 1902,
  ...
  SETTLE_MERCENARY_PLAYER_REWARDS = 1219,
  SYNC_RESET_MERCENARY_REWARD_COUNT = 1220,
  SAVE_BATTLE_REPLAY_DATA = 1221,
  DEL_BATTLE_REPLAY_DATA = 1222,
  SYNC_SAVE_BATTLE_REPLAY_DATA_STATUS = 1223,
  REQ_SET_SYSTEM_FUNCTION_FLAG = 1225,
  ACK_SET_SYSTEM_FUNCTION_FLAG = 1226,
  SYNC_SYSTEM_FUNCTION_UNLOCK = 1227,
  ...
  REQ_MARK_REDPOINT = 1336,
  ACK_MARK_REDPOINT = 1337,
  SYNC_REDPOINT_FLAG = 1338,
  ...
  DEL_ALL_PLAYER_REPLAY_ITEM = 1461,
  DEL_ALL_PLAYER_CHALLENGE_ITEM = 1462,
  SETTLE_BOTARENA_ATTACK_BATTLE_DATAS = 1463,
  SETTLE_BOTARENA_DEFENSIVE_BATTLE_DATAS = 1464,
  ...
  REQ_CLICK_BOTARENA_PROMPT_FORM = 1486,
  ACK_CLICK_BOTARENA_PROMPT_FORM = 1487,
  REQ_GET_BOTARENA_REPLAY_LIST = 1488,
  ACK_GET_BOTARENA_REPLAY_LIST = 1489,
  REQ_BOTARENA_BATTLE_REPLAY_CHECK = 1490,
  ACK_BOTARENA_BATTLE_REPLAY_CHECK = 1491,
  REQ_FINISHED_SWITCH_GRADE_AREA = 1492,
  ACK_FINISHED_SWITCH_GRADE_AREA = 1493,
  ...
  SYNC_GAME_DATA_RESET_EVENT = 1814,
  ...
  REQ_GM_WHITE_LIST = 10035,
  ACK_GM_WHITE_LIST = 10036,
...
constexpr EGameMsgID EGameMsgID_MAX = ACK_GM_WHITE_LIST;
...
constexpr NotificationEventType NotificationEventType_MAX = NET_SERVER_MAINTAIN;
...
enum ERedpointType : int {
  ...
  RPT_BEGINNING_MISSION_REWARD_DAY01 = 6,
  RPT_BEGINNING_MISSION_REWARD_DAY02 = 7,
  RPT_BEGINNING_MISSION_REWARD_DAY03 = 8,
  RPT_BEGINNING_MISSION_REWARD_DAY04 = 9,
  RPT_BEGINNING_MISSION_REWARD_DAY05 = 10,
  RPT_BEGINNING_MISSION_REWARD_DAY06 = 11,
  RPT_BEGINNING_MISSION_REWARD_DAY07 = 12,
  RPT_PVP_BATTLE_REPORT = 13,
...
constexpr ERedpointType ERedpointType_MAX = RPT_PVP_BATTLE_REPORT;
...
enum ERewardFlag : int {
  ERF_NONE = 0,
  ERF_COMMON = 1,
  ERF_EXTRA = 2,
  ERF_DECOMPOSE = 3,
  ERF_CONTINUOUS_WIN = 4,
  ERF_MINOR_DROP = 5,
  ERF_MAIN_DROP = 6,
  ERF_MUST_DROP = 7,
  ERF_FIRST_PASS = 8,
  ERF_THREE_STAR = 9,
  ERF_PROBABILITY_INC = 10,
  ERewardFlag_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ERewardFlag_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool ERewardFlag_IsValid(int value);
constexpr ERewardFlag ERewardFlag_MIN = ERF_NONE;
constexpr ERewardFlag ERewardFlag_MAX = ERF_PROBABILITY_INC;
constexpr int ERewardFlag_ARRAYSIZE = ERewardFlag_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ERewardFlag_descriptor();
template<typename T>
inline const std::string& ERewardFlag_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ERewardFlag>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ERewardFlag_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ERewardFlag_descriptor(), enum_t_value);
}
inline bool ERewardFlag_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ERewardFlag* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ERewardFlag>(
    ERewardFlag_descriptor(), name, value);
}
// ===================================================================
...
template <> struct is_proto_enum< ::KWMsg::ERewardFlag> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::KWMsg::ERewardFlag>() {
  return ::KWMsg::ERewardFlag_descriptor();
}
