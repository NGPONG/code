...
struct ObjectPropertyDefaultTypeInternal;
extern ObjectPropertyDefaultTypeInternal _ObjectProperty_default_instance_;
...
struct RewardInfoListDefaultTypeInternal;
extern RewardInfoListDefaultTypeInternal _RewardInfoList_default_instance_;
class Vector2;
...
template<> ::KWMsg::ObjectProperty* Arena::CreateMaybeMessage<::KWMsg::ObjectProperty>(Arena*);
...
template<> ::KWMsg::RewardInfoList* Arena::CreateMaybeMessage<::KWMsg::RewardInfoList>(Arena*);
...
class ObjectProperty final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KWMsg.ObjectProperty) */ {
 public:
  inline ObjectProperty() : ObjectProperty(nullptr) {}
  ~ObjectProperty() override;
  explicit constexpr ObjectProperty(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ObjectProperty(const ObjectProperty& from);
  ObjectProperty(ObjectProperty&& from) noexcept
    : ObjectProperty() {
    *this = ::std::move(from);
  }

  inline ObjectProperty& operator=(const ObjectProperty& from) {
    CopyFrom(from);
    return *this;
  }
  inline ObjectProperty& operator=(ObjectProperty&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const ObjectProperty& default_instance() {
    return *internal_default_instance();
  }
  static inline const ObjectProperty* internal_default_instance() {
    return reinterpret_cast<const ObjectProperty*>(
               &_ObjectProperty_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    32;

  friend void swap(ObjectProperty& a, ObjectProperty& b) {
    a.Swap(&b);
  }
  inline void Swap(ObjectProperty* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ObjectProperty* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline ObjectProperty* New() const final {
    return new ObjectProperty();
  }

  ObjectProperty* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ObjectProperty>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ObjectProperty& from);
  void MergeFrom(const ObjectProperty& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ObjectProperty* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "KWMsg.ObjectProperty";
  }
  protected:
  explicit ObjectProperty(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    kPlayerIdFieldNumber = 1,
    kPropertyIntFieldNumber = 2,
    kPropertyFloatFieldNumber = 3,
    kPropertyStringFieldNumber = 4,
    kPropertyObjectFieldNumber = 5,
    kPropertyVector2FieldNumber = 6,
    kPropertyVector3FieldNumber = 7,
  };
  // .KWMsg.Ident player_id = 1;
  bool has_player_id() const;
  private:
  ...
  // .KWMsg.PropertyInt property_int = 2;
  bool has_property_int() const;
  private:
  bool _internal_has_property_int() const;
  public:
  void clear_property_int();
  const ::KWMsg::PropertyInt& property_int() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::KWMsg::PropertyInt* release_property_int();
  ::KWMsg::PropertyInt* mutable_property_int();
  void set_allocated_property_int(::KWMsg::PropertyInt* property_int);
  private:
  const ::KWMsg::PropertyInt& _internal_property_int() const;
  ::KWMsg::PropertyInt* _internal_mutable_property_int();
  public:
  void unsafe_arena_set_allocated_property_int(
      ::KWMsg::PropertyInt* property_int);
  ::KWMsg::PropertyInt* unsafe_arena_release_property_int();

  // .KWMsg.PropertyFloat property_float = 3;
  bool has_property_float() const;
  private:
  bool _internal_has_property_float() const;
  public:
  void clear_property_float();
  const ::KWMsg::PropertyFloat& property_float() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::KWMsg::PropertyFloat* release_property_float();
  ::KWMsg::PropertyFloat* mutable_property_float();
  void set_allocated_property_float(::KWMsg::PropertyFloat* property_float);
  private:
  const ::KWMsg::PropertyFloat& _internal_property_float() const;
  ::KWMsg::PropertyFloat* _internal_mutable_property_float();
  public:
  void unsafe_arena_set_allocated_property_float(
      ::KWMsg::PropertyFloat* property_float);
  ::KWMsg::PropertyFloat* unsafe_arena_release_property_float();

  // .KWMsg.PropertyString property_string = 4;
  bool has_property_string() const;
  private:
  bool _internal_has_property_string() const;
  public:
  void clear_property_string();
  const ::KWMsg::PropertyString& property_string() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::KWMsg::PropertyString* release_property_string();
  ::KWMsg::PropertyString* mutable_property_string();
  void set_allocated_property_string(::KWMsg::PropertyString* property_string);
  private:
  const ::KWMsg::PropertyString& _internal_property_string() const;
  ::KWMsg::PropertyString* _internal_mutable_property_string();
  public:
  void unsafe_arena_set_allocated_property_string(
      ::KWMsg::PropertyString* property_string);
  ::KWMsg::PropertyString* unsafe_arena_release_property_string();

  // .KWMsg.PropertyObject property_object = 5;
  bool has_property_object() const;
  private:
  bool _internal_has_property_object() const;
  public:
  void clear_property_object();
  const ::KWMsg::PropertyObject& property_object() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::KWMsg::PropertyObject* release_property_object();
  ::KWMsg::PropertyObject* mutable_property_object();
  void set_allocated_property_object(::KWMsg::PropertyObject* property_object);
  private:
  const ::KWMsg::PropertyObject& _internal_property_object() const;
  ::KWMsg::PropertyObject* _internal_mutable_property_object();
  public:
  void unsafe_arena_set_allocated_property_object(
      ::KWMsg::PropertyObject* property_object);
  ::KWMsg::PropertyObject* unsafe_arena_release_property_object();

  // .KWMsg.PropertyVector2 property_vector2 = 6;
  bool has_property_vector2() const;
  private:
  bool _internal_has_property_vector2() const;
  public:
  void clear_property_vector2();
  const ::KWMsg::PropertyVector2& property_vector2() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::KWMsg::PropertyVector2* release_property_vector2();
  ::KWMsg::PropertyVector2* mutable_property_vector2();
  void set_allocated_property_vector2(::KWMsg::PropertyVector2* property_vector2);
  private:
  const ::KWMsg::PropertyVector2& _internal_property_vector2() const;
  ::KWMsg::PropertyVector2* _internal_mutable_property_vector2();
  public:
  void unsafe_arena_set_allocated_property_vector2(
      ::KWMsg::PropertyVector2* property_vector2);
  ::KWMsg::PropertyVector2* unsafe_arena_release_property_vector2();

  // .KWMsg.PropertyVector3 property_vector3 = 7;
  bool has_property_vector3() const;
  private:
  bool _internal_has_property_vector3() const;
  public:
  void clear_property_vector3();
  const ::KWMsg::PropertyVector3& property_vector3() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::KWMsg::PropertyVector3* release_property_vector3();
  ::KWMsg::PropertyVector3* mutable_property_vector3();
  void set_allocated_property_vector3(::KWMsg::PropertyVector3* property_vector3);
  private:
  const ::KWMsg::PropertyVector3& _internal_property_vector3() const;
  ::KWMsg::PropertyVector3* _internal_mutable_property_vector3();
  public:
  void unsafe_arena_set_allocated_property_vector3(
      ::KWMsg::PropertyVector3* property_vector3);
  ::KWMsg::PropertyVector3* unsafe_arena_release_property_vector3();

  // @@protoc_insertion_point(class_scope:KWMsg.ObjectProperty)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  ::KWMsg::Ident* player_id_;
  ::KWMsg::PropertyInt* property_int_;
  ::KWMsg::PropertyFloat* property_float_;
  ::KWMsg::PropertyString* property_string_;
  ::KWMsg::PropertyObject* property_object_;
  ::KWMsg::PropertyVector2* property_vector2_;
  ::KWMsg::PropertyVector3* property_vector3_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_kwmsgbase_2eproto;
};
// -------------------------------------------------------------------
...
class DeviceInfo final :
 ...
 public:
  ...
  // bytes game_ver = 12;
  void clear_game_ver();
  const std::string& game_ver() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_game_ver(ArgT0&& arg0, ArgT... args);
  std::string* mutable_game_ver();
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_game_ver();
  void set_allocated_game_ver(std::string* game_ver);
  private:
  const std::string& _internal_game_ver() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_game_ver(const std::string& value);
  std::string* _internal_mutable_game_ver();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr game_ver_;
...
class RewardInfo final :
 ...
 public:
  ...
  enum : int {
    kRewardFlagsFieldNumber = 3,
    kRewardIdFieldNumber = 1,
    kRewardGuidFieldNumber = 4,
    kRewardCountFieldNumber = 2,
  };
  // repeated .KWMsg.ERewardFlag reward_flags = 3;
  int reward_flags_size() const;
  private:
  int _internal_reward_flags_size() const;
  public:
  void clear_reward_flags();
  private:
  ::KWMsg::ERewardFlag _internal_reward_flags(int index) const;
  void _internal_add_reward_flags(::KWMsg::ERewardFlag value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* _internal_mutable_reward_flags();
  public:
  ::KWMsg::ERewardFlag reward_flags(int index) const;
  void set_reward_flags(int index, ::KWMsg::ERewardFlag value);
  void add_reward_flags(::KWMsg::ERewardFlag value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>& reward_flags() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>* mutable_reward_flags();
  ...
  bool has_reward_guid() const;
  private:
  bool _internal_has_reward_guid() const;
  public:
  void clear_reward_guid();
  const ::KWMsg::Ident& reward_guid() const;
  PROTOBUF_FUTURE_MUST_USE_RESULT ::KWMsg::Ident* release_reward_guid();
  ::KWMsg::Ident* mutable_reward_guid();
  void set_allocated_reward_guid(::KWMsg::Ident* reward_guid);
  private:
  const ::KWMsg::Ident& _internal_reward_guid() const;
  ::KWMsg::Ident* _internal_mutable_reward_guid();
  public:
  void unsafe_arena_set_allocated_reward_guid(
      ::KWMsg::Ident* reward_guid);
  ::KWMsg::Ident* unsafe_arena_release_reward_guid();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<int> reward_flags_;
  mutable std::atomic<int> _reward_flags_cached_byte_size_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr reward_id_;
  ::KWMsg::Ident* reward_guid_;
...
class RewardInfoList final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KWMsg.RewardInfoList) */ {
 public:
  inline RewardInfoList() : RewardInfoList(nullptr) {}
  ~RewardInfoList() override;
  explicit constexpr RewardInfoList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  RewardInfoList(const RewardInfoList& from);
  RewardInfoList(RewardInfoList&& from) noexcept
    : RewardInfoList() {
    *this = ::std::move(from);
  }

  inline RewardInfoList& operator=(const RewardInfoList& from) {
    CopyFrom(from);
    return *this;
  }
  inline RewardInfoList& operator=(RewardInfoList&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const RewardInfoList& default_instance() {
    return *internal_default_instance();
  }
  static inline const RewardInfoList* internal_default_instance() {
    return reinterpret_cast<const RewardInfoList*>(
               &_RewardInfoList_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    40;

  friend void swap(RewardInfoList& a, RewardInfoList& b) {
    a.Swap(&b);
  }
  inline void Swap(RewardInfoList* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RewardInfoList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline RewardInfoList* New() const final {
    return new RewardInfoList();
  }

  RewardInfoList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RewardInfoList>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const RewardInfoList& from);
  void MergeFrom(const RewardInfoList& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RewardInfoList* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "KWMsg.RewardInfoList";
  }
  protected:
  explicit RewardInfoList(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:KWMsg.RewardInfoList)
 private:
  class _Internal;
...
// .KWMsg.Ident player_id = 1;
inline bool ObjectProperty::_internal_has_player_id() const {
  return this != internal_default_instance() && player_id_ != nullptr;
}
inline bool ObjectProperty::has_player_id() const {
  return _internal_has_player_id();
}
inline void ObjectProperty::clear_player_id() {
  if (GetArenaForAllocation() == nullptr && player_id_ != nullptr) {
    delete player_id_;
  }
  player_id_ = nullptr;
}
inline const ::KWMsg::Ident& ObjectProperty::_internal_player_id() const {
  const ::KWMsg::Ident* p = player_id_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::Ident&>(
      ::KWMsg::_Ident_default_instance_);
}
inline const ::KWMsg::Ident& ObjectProperty::player_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ObjectProperty.player_id)
  return _internal_player_id();
}
inline void ObjectProperty::unsafe_arena_set_allocated_player_id(
    ::KWMsg::Ident* player_id) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(player_id_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.ObjectProperty.player_id)
}
inline ::KWMsg::Ident* ObjectProperty::release_player_id() {
...
inline ::KWMsg::Ident* ObjectProperty::unsafe_arena_release_player_id() {
  // @@protoc_insertion_point(field_release:KWMsg.ObjectProperty.player_id)
  
  ::KWMsg::Ident* temp = player_id_;
  player_id_ = nullptr;
  return temp;
}
inline ::KWMsg::Ident* ObjectProperty::_internal_mutable_player_id() {
...
inline ::KWMsg::Ident* ObjectProperty::mutable_player_id() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ObjectProperty.player_id)
  return _internal_mutable_player_id();
}
inline void ObjectProperty::set_allocated_player_id(::KWMsg::Ident* player_id) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete player_id_;
  }
  ...
  player_id_ = player_id;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ObjectProperty.player_id)
}

// .KWMsg.PropertyInt property_int = 2;
inline bool ObjectProperty::_internal_has_property_int() const {
  return this != internal_default_instance() && property_int_ != nullptr;
}
inline bool ObjectProperty::has_property_int() const {
  return _internal_has_property_int();
}
inline void ObjectProperty::clear_property_int() {
  if (GetArenaForAllocation() == nullptr && property_int_ != nullptr) {
    delete property_int_;
  }
  property_int_ = nullptr;
}
inline const ::KWMsg::PropertyInt& ObjectProperty::_internal_property_int() const {
  const ::KWMsg::PropertyInt* p = property_int_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::PropertyInt&>(
      ::KWMsg::_PropertyInt_default_instance_);
}
inline const ::KWMsg::PropertyInt& ObjectProperty::property_int() const {
  // @@protoc_insertion_point(field_get:KWMsg.ObjectProperty.property_int)
  return _internal_property_int();
}
inline void ObjectProperty::unsafe_arena_set_allocated_property_int(
    ::KWMsg::PropertyInt* property_int) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(property_int_);
  }
  property_int_ = property_int;
  if (property_int) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.ObjectProperty.property_int)
}
inline ::KWMsg::PropertyInt* ObjectProperty::release_property_int() {
  
  ::KWMsg::PropertyInt* temp = property_int_;
  property_int_ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::KWMsg::PropertyInt* ObjectProperty::unsafe_arena_release_property_int() {
  // @@protoc_insertion_point(field_release:KWMsg.ObjectProperty.property_int)
  
  ::KWMsg::PropertyInt* temp = property_int_;
  property_int_ = nullptr;
  return temp;
}
inline ::KWMsg::PropertyInt* ObjectProperty::_internal_mutable_property_int() {
  
  if (property_int_ == nullptr) {
    auto* p = CreateMaybeMessage<::KWMsg::PropertyInt>(GetArenaForAllocation());
    property_int_ = p;
  }
  return property_int_;
}
inline ::KWMsg::PropertyInt* ObjectProperty::mutable_property_int() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ObjectProperty.property_int)
  return _internal_mutable_property_int();
}
inline void ObjectProperty::set_allocated_property_int(::KWMsg::PropertyInt* property_int) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete property_int_;
  }
  if (property_int) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::KWMsg::PropertyInt>::GetOwningArena(property_int);
    if (message_arena != submessage_arena) {
      property_int = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, property_int, submessage_arena);
    }
  ...
  property_int_ = property_int;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ObjectProperty.property_int)
}

// .KWMsg.PropertyFloat property_float = 3;
inline bool ObjectProperty::_internal_has_property_float() const {
  return this != internal_default_instance() && property_float_ != nullptr;
}
inline bool ObjectProperty::has_property_float() const {
  return _internal_has_property_float();
}
inline void ObjectProperty::clear_property_float() {
  if (GetArenaForAllocation() == nullptr && property_float_ != nullptr) {
    delete property_float_;
  }
  property_float_ = nullptr;
}
inline const ::KWMsg::PropertyFloat& ObjectProperty::_internal_property_float() const {
  const ::KWMsg::PropertyFloat* p = property_float_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::PropertyFloat&>(
      ::KWMsg::_PropertyFloat_default_instance_);
}
inline const ::KWMsg::PropertyFloat& ObjectProperty::property_float() const {
  // @@protoc_insertion_point(field_get:KWMsg.ObjectProperty.property_float)
  return _internal_property_float();
}
inline void ObjectProperty::unsafe_arena_set_allocated_property_float(
    ::KWMsg::PropertyFloat* property_float) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(property_float_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.ObjectProperty.property_float)
}
inline ::KWMsg::PropertyFloat* ObjectProperty::release_property_float() {
  
  ::KWMsg::PropertyFloat* temp = property_float_;
  property_float_ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::KWMsg::PropertyFloat* ObjectProperty::unsafe_arena_release_property_float() {
  // @@protoc_insertion_point(field_release:KWMsg.ObjectProperty.property_float)
  
  ::KWMsg::PropertyFloat* temp = property_float_;
  property_float_ = nullptr;
  return temp;
}
inline ::KWMsg::PropertyFloat* ObjectProperty::_internal_mutable_property_float() {
  
  if (property_float_ == nullptr) {
    auto* p = CreateMaybeMessage<::KWMsg::PropertyFloat>(GetArenaForAllocation());
    property_float_ = p;
  }
  return property_float_;
}
inline ::KWMsg::PropertyFloat* ObjectProperty::mutable_property_float() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ObjectProperty.property_float)
  return _internal_mutable_property_float();
}
inline void ObjectProperty::set_allocated_property_float(::KWMsg::PropertyFloat* property_float) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete property_float_;
  }
  if (property_float) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::KWMsg::PropertyFloat>::GetOwningArena(property_float);
    if (message_arena != submessage_arena) {
      property_float = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
  ...
  property_float_ = property_float;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ObjectProperty.property_float)
}

// .KWMsg.PropertyString property_string = 4;
inline bool ObjectProperty::_internal_has_property_string() const {
  return this != internal_default_instance() && property_string_ != nullptr;
}
inline bool ObjectProperty::has_property_string() const {
  return _internal_has_property_string();
}
inline void ObjectProperty::clear_property_string() {
  if (GetArenaForAllocation() == nullptr && property_string_ != nullptr) {
    delete property_string_;
  }
  property_string_ = nullptr;
}
inline const ::KWMsg::PropertyString& ObjectProperty::_internal_property_string() const {
  const ::KWMsg::PropertyString* p = property_string_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::PropertyString&>(
      ::KWMsg::_PropertyString_default_instance_);
}
inline const ::KWMsg::PropertyString& ObjectProperty::property_string() const {
  // @@protoc_insertion_point(field_get:KWMsg.ObjectProperty.property_string)
  return _internal_property_string();
}
inline void ObjectProperty::unsafe_arena_set_allocated_property_string(
    ::KWMsg::PropertyString* property_string) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(property_string_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.ObjectProperty.property_string)
}
inline ::KWMsg::PropertyString* ObjectProperty::release_property_string() {
  
  ::KWMsg::PropertyString* temp = property_string_;
  property_string_ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::KWMsg::PropertyString* ObjectProperty::unsafe_arena_release_property_string() {
  // @@protoc_insertion_point(field_release:KWMsg.ObjectProperty.property_string)
  
  ::KWMsg::PropertyString* temp = property_string_;
  property_string_ = nullptr;
  return temp;
}
inline ::KWMsg::PropertyString* ObjectProperty::_internal_mutable_property_string() {
  
  if (property_string_ == nullptr) {
    auto* p = CreateMaybeMessage<::KWMsg::PropertyString>(GetArenaForAllocation());
    property_string_ = p;
  }
  return property_string_;
}
inline ::KWMsg::PropertyString* ObjectProperty::mutable_property_string() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ObjectProperty.property_string)
  return _internal_mutable_property_string();
}
inline void ObjectProperty::set_allocated_property_string(::KWMsg::PropertyString* property_string) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete property_string_;
  }
  if (property_string) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::KWMsg::PropertyString>::GetOwningArena(property_string);
    if (message_arena != submessage_arena) {
      property_string = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
  ...
  property_string_ = property_string;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ObjectProperty.property_string)
}

// .KWMsg.PropertyObject property_object = 5;
inline bool ObjectProperty::_internal_has_property_object() const {
  return this != internal_default_instance() && property_object_ != nullptr;
}
inline bool ObjectProperty::has_property_object() const {
  return _internal_has_property_object();
}
inline void ObjectProperty::clear_property_object() {
  if (GetArenaForAllocation() == nullptr && property_object_ != nullptr) {
    delete property_object_;
  }
  property_object_ = nullptr;
}
inline const ::KWMsg::PropertyObject& ObjectProperty::_internal_property_object() const {
  const ::KWMsg::PropertyObject* p = property_object_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::PropertyObject&>(
      ::KWMsg::_PropertyObject_default_instance_);
}
inline const ::KWMsg::PropertyObject& ObjectProperty::property_object() const {
  // @@protoc_insertion_point(field_get:KWMsg.ObjectProperty.property_object)
  return _internal_property_object();
}
inline void ObjectProperty::unsafe_arena_set_allocated_property_object(
    ::KWMsg::PropertyObject* property_object) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(property_object_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.ObjectProperty.property_object)
}
inline ::KWMsg::PropertyObject* ObjectProperty::release_property_object() {
  
  ::KWMsg::PropertyObject* temp = property_object_;
  property_object_ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::KWMsg::PropertyObject* ObjectProperty::unsafe_arena_release_property_object() {
  // @@protoc_insertion_point(field_release:KWMsg.ObjectProperty.property_object)
  
  ::KWMsg::PropertyObject* temp = property_object_;
  property_object_ = nullptr;
  return temp;
}
inline ::KWMsg::PropertyObject* ObjectProperty::_internal_mutable_property_object() {
  
  if (property_object_ == nullptr) {
    auto* p = CreateMaybeMessage<::KWMsg::PropertyObject>(GetArenaForAllocation());
    property_object_ = p;
  }
  return property_object_;
}
inline ::KWMsg::PropertyObject* ObjectProperty::mutable_property_object() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ObjectProperty.property_object)
  return _internal_mutable_property_object();
}
inline void ObjectProperty::set_allocated_property_object(::KWMsg::PropertyObject* property_object) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete property_object_;
  }
  if (property_object) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::KWMsg::PropertyObject>::GetOwningArena(property_object);
    if (message_arena != submessage_arena) {
      property_object = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, property_object, submessage_arena);
    }
  ...
  property_object_ = property_object;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ObjectProperty.property_object)
}

// .KWMsg.PropertyVector2 property_vector2 = 6;
inline bool ObjectProperty::_internal_has_property_vector2() const {
  return this != internal_default_instance() && property_vector2_ != nullptr;
}
inline bool ObjectProperty::has_property_vector2() const {
  return _internal_has_property_vector2();
}
inline void ObjectProperty::clear_property_vector2() {
  if (GetArenaForAllocation() == nullptr && property_vector2_ != nullptr) {
    delete property_vector2_;
  }
  property_vector2_ = nullptr;
}
inline const ::KWMsg::PropertyVector2& ObjectProperty::_internal_property_vector2() const {
  const ::KWMsg::PropertyVector2* p = property_vector2_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::PropertyVector2&>(
      ::KWMsg::_PropertyVector2_default_instance_);
}
inline const ::KWMsg::PropertyVector2& ObjectProperty::property_vector2() const {
  // @@protoc_insertion_point(field_get:KWMsg.ObjectProperty.property_vector2)
  return _internal_property_vector2();
}
inline void ObjectProperty::unsafe_arena_set_allocated_property_vector2(
    ::KWMsg::PropertyVector2* property_vector2) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(property_vector2_);
  }
  property_vector2_ = property_vector2;
  if (property_vector2) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.ObjectProperty.property_vector2)
}
inline ::KWMsg::PropertyVector2* ObjectProperty::release_property_vector2() {
  
  ::KWMsg::PropertyVector2* temp = property_vector2_;
  property_vector2_ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::KWMsg::PropertyVector2* ObjectProperty::unsafe_arena_release_property_vector2() {
  // @@protoc_insertion_point(field_release:KWMsg.ObjectProperty.property_vector2)
  
  ::KWMsg::PropertyVector2* temp = property_vector2_;
  property_vector2_ = nullptr;
  return temp;
}
inline ::KWMsg::PropertyVector2* ObjectProperty::_internal_mutable_property_vector2() {
  
  if (property_vector2_ == nullptr) {
    auto* p = CreateMaybeMessage<::KWMsg::PropertyVector2>(GetArenaForAllocation());
    property_vector2_ = p;
  }
  return property_vector2_;
}
inline ::KWMsg::PropertyVector2* ObjectProperty::mutable_property_vector2() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ObjectProperty.property_vector2)
  return _internal_mutable_property_vector2();
}
inline void ObjectProperty::set_allocated_property_vector2(::KWMsg::PropertyVector2* property_vector2) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete property_vector2_;
  }
  if (property_vector2) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::KWMsg::PropertyVector2>::GetOwningArena(property_vector2);
    if (message_arena != submessage_arena) {
      property_vector2 = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, property_vector2, submessage_arena);
    }
  ...
  property_vector2_ = property_vector2;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ObjectProperty.property_vector2)
}

// .KWMsg.PropertyVector3 property_vector3 = 7;
inline bool ObjectProperty::_internal_has_property_vector3() const {
  return this != internal_default_instance() && property_vector3_ != nullptr;
}
inline bool ObjectProperty::has_property_vector3() const {
  return _internal_has_property_vector3();
}
inline void ObjectProperty::clear_property_vector3() {
  if (GetArenaForAllocation() == nullptr && property_vector3_ != nullptr) {
    delete property_vector3_;
  }
  property_vector3_ = nullptr;
}
inline const ::KWMsg::PropertyVector3& ObjectProperty::_internal_property_vector3() const {
  const ::KWMsg::PropertyVector3* p = property_vector3_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::PropertyVector3&>(
      ::KWMsg::_PropertyVector3_default_instance_);
}
inline const ::KWMsg::PropertyVector3& ObjectProperty::property_vector3() const {
  // @@protoc_insertion_point(field_get:KWMsg.ObjectProperty.property_vector3)
  return _internal_property_vector3();
}
inline void ObjectProperty::unsafe_arena_set_allocated_property_vector3(
    ::KWMsg::PropertyVector3* property_vector3) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(property_vector3_);
  }
  property_vector3_ = property_vector3;
  if (property_vector3) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.ObjectProperty.property_vector3)
}
inline ::KWMsg::PropertyVector3* ObjectProperty::release_property_vector3() {
  
  ::KWMsg::PropertyVector3* temp = property_vector3_;
  property_vector3_ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::KWMsg::PropertyVector3* ObjectProperty::unsafe_arena_release_property_vector3() {
  // @@protoc_insertion_point(field_release:KWMsg.ObjectProperty.property_vector3)
  
  ::KWMsg::PropertyVector3* temp = property_vector3_;
  property_vector3_ = nullptr;
  return temp;
}
inline ::KWMsg::PropertyVector3* ObjectProperty::_internal_mutable_property_vector3() {
  
  if (property_vector3_ == nullptr) {
    auto* p = CreateMaybeMessage<::KWMsg::PropertyVector3>(GetArenaForAllocation());
    property_vector3_ = p;
  }
  return property_vector3_;
}
inline ::KWMsg::PropertyVector3* ObjectProperty::mutable_property_vector3() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ObjectProperty.property_vector3)
  return _internal_mutable_property_vector3();
}
inline void ObjectProperty::set_allocated_property_vector3(::KWMsg::PropertyVector3* property_vector3) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete property_vector3_;
  }
  if (property_vector3) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::KWMsg::PropertyVector3>::GetOwningArena(property_vector3);
    if (message_arena != submessage_arena) {
      property_vector3 = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, property_vector3, submessage_arena);
    }
  ...
  property_vector3_ = property_vector3;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ObjectProperty.property_vector3)
}
...
inline const std::string& DeviceInfo::language() const {
  // @@protoc_insertion_point(field_get:KWMsg.DeviceInfo.language)
  return _internal_language();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DeviceInfo::set_language(ArgT0&& arg0, ArgT... args) {
 
 language_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.DeviceInfo.language)
}
inline std::string* DeviceInfo::mutable_language() {
  // @@protoc_insertion_point(field_mutable:KWMsg.DeviceInfo.language)
  return _internal_mutable_language();
}
inline const std::string& DeviceInfo::_internal_language() const {
  return language_.Get();
}
inline void DeviceInfo::_internal_set_language(const std::string& value) {
  
  language_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* DeviceInfo::_internal_mutable_language() {
...
inline std::string* DeviceInfo::release_language() {
  // @@protoc_insertion_point(field_release:KWMsg.DeviceInfo.language)
...
inline void DeviceInfo::set_allocated_language(std::string* language) {
  ...
  language_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), language,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.DeviceInfo.language)
}

// bytes game_ver = 12;
inline void DeviceInfo::clear_game_ver() {
  game_ver_.ClearToEmpty();
}
inline const std::string& DeviceInfo::game_ver() const {
  // @@protoc_insertion_point(field_get:KWMsg.DeviceInfo.game_ver)
  return _internal_game_ver();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DeviceInfo::set_game_ver(ArgT0&& arg0, ArgT... args) {
 
 game_ver_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.DeviceInfo.game_ver)
}
inline std::string* DeviceInfo::mutable_game_ver() {
  // @@protoc_insertion_point(field_mutable:KWMsg.DeviceInfo.game_ver)
  return _internal_mutable_game_ver();
}
inline const std::string& DeviceInfo::_internal_game_ver() const {
  return game_ver_.Get();
}
inline void DeviceInfo::_internal_set_game_ver(const std::string& value) {
  
  game_ver_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* DeviceInfo::_internal_mutable_game_ver() {
  
  return game_ver_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* DeviceInfo::release_game_ver() {
  // @@protoc_insertion_point(field_release:KWMsg.DeviceInfo.game_ver)
  return game_ver_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void DeviceInfo::set_allocated_game_ver(std::string* game_ver) {
  if (game_ver != nullptr) {
    
  } else {
    
  }
  game_ver_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), game_ver,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.DeviceInfo.game_ver)
}
...
// repeated .KWMsg.ERewardFlag reward_flags = 3;
inline int RewardInfo::_internal_reward_flags_size() const {
  return reward_flags_.size();
}
inline int RewardInfo::reward_flags_size() const {
  return _internal_reward_flags_size();
}
inline void RewardInfo::clear_reward_flags() {
  reward_flags_.Clear();
}
inline ::KWMsg::ERewardFlag RewardInfo::_internal_reward_flags(int index) const {
  return static_cast< ::KWMsg::ERewardFlag >(reward_flags_.Get(index));
}
inline ::KWMsg::ERewardFlag RewardInfo::reward_flags(int index) const {
  // @@protoc_insertion_point(field_get:KWMsg.RewardInfo.reward_flags)
  return _internal_reward_flags(index);
}
inline void RewardInfo::set_reward_flags(int index, ::KWMsg::ERewardFlag value) {
  reward_flags_.Set(index, value);
  // @@protoc_insertion_point(field_set:KWMsg.RewardInfo.reward_flags)
}
inline void RewardInfo::_internal_add_reward_flags(::KWMsg::ERewardFlag value) {
  reward_flags_.Add(value);
}
inline void RewardInfo::add_reward_flags(::KWMsg::ERewardFlag value) {
  // @@protoc_insertion_point(field_add:KWMsg.RewardInfo.reward_flags)
  _internal_add_reward_flags(value);
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>&
RewardInfo::reward_flags() const {
  // @@protoc_insertion_point(field_list:KWMsg.RewardInfo.reward_flags)
  return reward_flags_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>*
RewardInfo::_internal_mutable_reward_flags() {
  return &reward_flags_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<int>*
RewardInfo::mutable_reward_flags() {
  // @@protoc_insertion_point(field_mutable_list:KWMsg.RewardInfo.reward_flags)
  return _internal_mutable_reward_flags();
}

// .KWMsg.Ident reward_guid = 4;
inline bool RewardInfo::_internal_has_reward_guid() const {
  return this != internal_default_instance() && reward_guid_ != nullptr;
}
inline bool RewardInfo::has_reward_guid() const {
  return _internal_has_reward_guid();
}
inline void RewardInfo::clear_reward_guid() {
  if (GetArenaForAllocation() == nullptr && reward_guid_ != nullptr) {
    delete reward_guid_;
  }
  reward_guid_ = nullptr;
}
inline const ::KWMsg::Ident& RewardInfo::_internal_reward_guid() const {
  const ::KWMsg::Ident* p = reward_guid_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::Ident&>(
      ::KWMsg::_Ident_default_instance_);
}
inline const ::KWMsg::Ident& RewardInfo::reward_guid() const {
  // @@protoc_insertion_point(field_get:KWMsg.RewardInfo.reward_guid)
  return _internal_reward_guid();
}
inline void RewardInfo::unsafe_arena_set_allocated_reward_guid(
    ::KWMsg::Ident* reward_guid) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(reward_guid_);
  }
  reward_guid_ = reward_guid;
  if (reward_guid) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.RewardInfo.reward_guid)
}
inline ::KWMsg::Ident* RewardInfo::release_reward_guid() {
  
  ::KWMsg::Ident* temp = reward_guid_;
  reward_guid_ = nullptr;
  if (GetArenaForAllocation() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::KWMsg::Ident* RewardInfo::unsafe_arena_release_reward_guid() {
  // @@protoc_insertion_point(field_release:KWMsg.RewardInfo.reward_guid)
  
  ::KWMsg::Ident* temp = reward_guid_;
  reward_guid_ = nullptr;
  return temp;
}
inline ::KWMsg::Ident* RewardInfo::_internal_mutable_reward_guid() {
  
  if (reward_guid_ == nullptr) {
    auto* p = CreateMaybeMessage<::KWMsg::Ident>(GetArenaForAllocation());
    reward_guid_ = p;
  }
  return reward_guid_;
}
inline ::KWMsg::Ident* RewardInfo::mutable_reward_guid() {
  // @@protoc_insertion_point(field_mutable:KWMsg.RewardInfo.reward_guid)
  return _internal_mutable_reward_guid();
}
inline void RewardInfo::set_allocated_reward_guid(::KWMsg::Ident* reward_guid) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reward_guid_;
  }
  if (reward_guid) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::KWMsg::Ident>::GetOwningArena(reward_guid);
    if (message_arena != submessage_arena) {
      reward_guid = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, reward_guid, submessage_arena);
    }
  ...
  reward_guid_ = reward_guid;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.RewardInfo.reward_guid)
}
...
// repeated .KWMsg.RewardInfo list = 1;
inline int RewardInfoList::_internal_list_size() const {
  return list_.size();
}
inline int RewardInfoList::list_size() const {
  return _internal_list_size();
}
inline void RewardInfoList::clear_list() {
  list_.Clear();
}
inline ::KWMsg::RewardInfo* RewardInfoList::mutable_list(int index) {
  // @@protoc_insertion_point(field_mutable:KWMsg.RewardInfoList.list)
  return list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::RewardInfo >*
RewardInfoList::mutable_list() {
  // @@protoc_insertion_point(field_mutable_list:KWMsg.RewardInfoList.list)
  return &list_;
}
inline const ::KWMsg::RewardInfo& RewardInfoList::_internal_list(int index) const {
  return list_.Get(index);
}
inline const ::KWMsg::RewardInfo& RewardInfoList::list(int index) const {
  // @@protoc_insertion_point(field_get:KWMsg.RewardInfoList.list)
  return _internal_list(index);
}
inline ::KWMsg::RewardInfo* RewardInfoList::_internal_add_list() {
  return list_.Add();
}
inline ::KWMsg::RewardInfo* RewardInfoList::add_list() {
  // @@protoc_insertion_point(field_add:KWMsg.RewardInfoList.list)
  return _internal_add_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::RewardInfo >&
RewardInfoList::list() const {
  // @@protoc_insertion_point(field_list:KWMsg.RewardInfoList.list)
  return list_;
}
