...
enum EGameEventCode : int {
  ...
  GIFT_BOX_ITEM_NOT_ENOUGH = 32,
  GIFT_BOX_MAX_LIMIT = 33,
  GIFT_BOX_MUST_BE_FULL = 34,
  FREE_GIFT_BOX_MUST_HAVE_ONE_GIFT = 35,
  FREE_GIFT_COUNT_NOT_ENOUGH = 36,
  GIFT_ITEM_NOT_ENOUGH = 37,
  CAN_NOT_SEND_UNLOCK_GIFT = 38,
  MAGICAL_MEDICINE_ITEM_NOT_ENOUGH = 39,
  MAX_WITCH_LEVEL = 40,
  MAX_WITCH_EMOTION_LEVEL = 41,
  INVALID_WITCH_SKIN_ID = 42,
  WITCH_SKIN_IS_ALREADY_UNLOCKED = 43,
  DIAMOND_NOT_ENOUGH = 44,
  AT_LEAST_SR_CARD = 45,
  ALREADY_SET_HOUSE_KEEPER = 46,
  CURRENT_WITCH_IS_NOT_HOUSE_KEEPER = 47,
  CURRENT_SKIN_IS_NOT_UNLOCK = 48,
  ...
  EXPLORE_NODE_NOT_UNLOCK = 320,
  EXPLORE_MAP_NOT_UNLOCK = 321,
  EXPLORE_INVALID_NODE_ID = 322,
  EXPLORE_ALREADY_LAST_NODE = 323,
  EXPLORE_UNLOCK_MAP_CONDITION_NOT_PASS = 324,
  EXPLORE_ALREADY_UNLOCK_NODE = 325,
  EXPLORE_ALREADY_UNLOCK_MAP = 326,
  EXPLORE_AREA_REWARDS_ALREADY_RECEIVE = 327,
  EXPLORE_AREA_REWARDS_COND_NOT_PASS = 328,
  EXPLORE_MAP_MAIN_LINE_REWARDS_ALREADY_RECEIVE = 329,
  EXPLORE_MAP_MAIN_LINE_REWARDS_COND_NOT_PASS = 330,
  EXPLORE_MAP_BRANCH_LINE_REWARDS_ALREADY_RECEIVE = 331,
  EXPLORE_MAP_BRANCH_LINE_REWARDS_COND_NOT_PASS = 332,
  EXPLORE_NODE_NOT_COMPLETE = 333,
  EXPLORE_THREE_STAR_NODE_NOT_FULL = 334,
  EXPLORE_SWEEP_CONSUME_NOT_ENOUGH = 335,
  EXPLORE_CHALLENGE_CONSUME_NOT_ENOUGH = 336,
  EXPLORE_NODE_EVENT_REPEACT_CHALLENGE = 337,
  DISPATCH_NOT_ENABLED = 350,
  DISPATCH_APPOINT_AREA_INVALID = 351,
  DISPATCH_SWITCH_AREA_IN_CD = 352,
  DISPATCH_SWITCH_AREA_SAME = 353,
  DISPATCH_AFFAIR_NOT_EXIST = 354,
  DISPATCH_AFFAIR_POSITION_NOT_FINISHE = 355,
  DISPATCH_AFFAIR_POSITION_INVALID = 356,
  DISPATCH_AFFAIR_POSITION_RUNNING = 357,
  DISPATCH_AFFAIR_POSITION_EMPTY = 358,
  DISPATCH_AFFAIR_AREA_TYPE_INVALID = 359,
  DISPATCH_WITCH_NOT_UNLOCKED = 360,
  DISPATCH_WITCH_AFFAIR_NOT_FNISHED = 361,
  DISPATCH_WITCH_IN_BLACKLIST = 362,
  DISPATCH_DRESS_UP_NOT_OPEN = 363,
  DISPATCH_WITCH_AFFAIR_NOT_OPEN = 364,
  DISPATCH_WITCH_FRAGMENT_NOT_OPEN = 365,
  DISPATCH_QUICK_COLLECT_NOT_OPEN = 366,
  DISPATCH_APPOINT_ALREADY_START = 367,
  DISPATCH_APPOINT_NOT_START = 368,
  HOUSEKEEPER_SIGNIN_NOT_INIT = 381,
  HOUSEKEEPER_SIGNIN_ALREADY_INIT = 382,
  HOUSEKEEPER_SIGNIN_ALREADY_FINISHED = 383,
  ...
  STAR_LEVEL_INVALID_ITEM_ID = 420,
  STAR_LEVEL_DEBRIS_NOT_ENOUGH = 421,
  STAR_LEVEL_MAX_LIMITED = 422,
...
constexpr EGameEventCode EGameEventCode_MAX = COMMUNITY_ALREADY_SIGN_IN;
...
enum EGameMsgID : int {
  ...
  REQ_GET_EXPLORE_MAP_STAR_REWARDS = 1047,
  ACK_GET_EXPLORE_MAP_STAR_REWARDS = 1048,
  REQ_GET_EXPLORE_MAP_BRANCH_LINE_REWARDS = 1049,
  ACK_GET_EXPLORE_MAP_BRANCH_LINE_REWARDS = 1050,
  REQ_UPGRADE_EXPLORE_GUIDER_FRIENDSHIP = 1051,
  ACK_UPGRADE_EXPLORE_GUIDER_FRIENDSHIP = 1052,
  REQ_GET_APPOINT_REWARD = 1060,
  ACK_GET_APPOINT_REWARD = 1061,
  REQ_SWITCH_APPOINT_AREA = 1062,
  ACK_SWITCH_APPOINT_AREA = 1063,
  REQ_START_AFFAIR = 1064,
  ACK_START_AFFAIR = 1065,
  REQ_TERMINATE_AFFAIR = 1066,
  ACK_TERMINATE_AFFAIR = 1067,
  REQ_GET_AFFAIR_REWARD = 1068,
  ACK_GET_AFFAIR_REWARD = 1069,
  REQ_DELETE_AFFAIR = 1070,
  ACK_DELETE_AFFAIR = 1071,
  REQ_START_APPOINT = 1072,
  ACK_START_APPOINT = 1073,
  REQ_HOUSEKEEPER_INIT_SIGNIN = 1080,
  ACK_HOUSEKEEPER_INIT_SIGNIN = 1081,
  REQ_HOUSEKEEPER_FINISHED_SIGNIN = 1082,
  ACK_HOUSEKEEPER_FINISHED_SIGNIN = 1083,
  REQ_SET_HOUSE_KEEPER = 1084,
  ACK_SET_HOUSE_KEEPER = 1085,
  REQ_SET_HOUSE_KEEPER_SKIN_ID = 1086,
  ACK_SET_HOUSE_KEEPER_SKIN_ID = 1087,
  ...
  SYNC_ADD_PRE_SEND_ALL_PLAYERS_MAILS = 1097,
  SYNC_DEL_PRE_SEND_ALL_PLAYERS_MAILS = 1098,
  SYNC_ADD_PRE_SEND_PLAYER_MAILS = 1099,
  SYNC_DEL_PRE_SEND_PLAYER_MAILS = 1900,
  SYNC_PLAYER_MAIL_SESSIONS = 1901,
  ...
  SYNC_BOTARENA_BATTLE_IS_READY = 1461,
  ...
  ADD_PLAYER_SHOP_RECEIPT = 1500,
  UPD_PLAYER_SHOP_RECEIPT = 1501,
  DEL_PLAYER_SHOP_RECEIPT = 1502,
  DEL_PLAYER_SHOP_RECEIPTS = 1503,
...
constexpr EGameMsgID EGameMsgID_MAX = ACK_GM_CHAT_MUZZLE;
...
constexpr EBattleType EBattleType_MAX = BATTLE_TYPE_BOT_ARENA;
...
constexpr ShopType ShopType_MIN = ST_NONE;
constexpr ShopType ShopType_MAX = ST_BOTARENA;
...
enum ShopListingType : int {
  SLT_Finity = 0,
  SLT_Infinity = 1,
  ShopListingType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ShopListingType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool ShopListingType_IsValid(int value);
constexpr ShopListingType ShopListingType_MIN = SLT_Finity;
constexpr ShopListingType ShopListingType_MAX = SLT_Infinity;
constexpr int ShopListingType_ARRAYSIZE = ShopListingType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ShopListingType_descriptor();
template<typename T>
inline const std::string& ShopListingType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ShopListingType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ShopListingType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ShopListingType_descriptor(), enum_t_value);
}
inline bool ShopListingType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ShopListingType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ShopListingType>(
    ShopListingType_descriptor(), name, value);
}
...
template <> struct is_proto_enum< ::KWMsg::ShopType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::KWMsg::ShopType>() {
  return ::KWMsg::ShopType_descriptor();
}
template <> struct is_proto_enum< ::KWMsg::ShopListingType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::KWMsg::ShopListingType>() {
  return ::KWMsg::ShopListingType_descriptor();
}
