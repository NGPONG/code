...
constexpr BTLSkillState BTLSkillState_MAX = BSS_NO_USE_TIMES;
...
class BTLEffect final :
 ...
 public:
  ...
  enum : int {
    ...
    kHealFieldNumber = 9,
    kSummonFieldNumber = 10,
    kBuffFieldNumber = 11,
    kTransformFieldNumber = 12,
...
class AckBTLEndInfo final :
 ...
 public:
  ...
  ::KWMsg::BTLRewardInfo* mutable_extra_reward_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::BTLRewardInfo >*
      mutable_extra_reward_list();
  private:
  const ::KWMsg::BTLRewardInfo& _internal_extra_reward_list(int index) const;
  ::KWMsg::BTLRewardInfo* _internal_add_extra_reward_list();
  public:
  const ::KWMsg::BTLRewardInfo& extra_reward_list(int index) const;
  ::KWMsg::BTLRewardInfo* add_extra_reward_list();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::BTLRewardInfo >&
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::BTLRewardInfo > extra_reward_list_;
  ::KWMsg::Ident* player_id_;
...
// int32 reward_flag = 3;
inline void BTLRewardInfo::clear_reward_flag() {
  reward_flag_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 BTLRewardInfo::_internal_reward_flag() const {
  return reward_flag_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 BTLRewardInfo::reward_flag() const {
  // @@protoc_insertion_point(field_get:KWMsg.BTLRewardInfo.reward_flag)
  return _internal_reward_flag();
}
inline void BTLRewardInfo::_internal_set_reward_flag(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  reward_flag_ = value;
}
inline void BTLRewardInfo::set_reward_flag(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_reward_flag(value);
  // @@protoc_insertion_point(field_set:KWMsg.BTLRewardInfo.reward_flag)
}

// .KWMsg.Ident reward_guid = 4;
inline bool BTLRewardInfo::_internal_has_reward_guid() const {
  return this != internal_default_instance() && reward_guid_ != nullptr;
}
inline bool BTLRewardInfo::has_reward_guid() const {
  return _internal_has_reward_guid();
}
inline const ::KWMsg::Ident& BTLRewardInfo::_internal_reward_guid() const {
  const ::KWMsg::Ident* p = reward_guid_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::Ident&>(
      ::KWMsg::_Ident_default_instance_);
}
inline const ::KWMsg::Ident& BTLRewardInfo::reward_guid() const {
  // @@protoc_insertion_point(field_get:KWMsg.BTLRewardInfo.reward_guid)
  return _internal_reward_guid();
}
inline void BTLRewardInfo::unsafe_arena_set_allocated_reward_guid(
    ::KWMsg::Ident* reward_guid) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.BTLRewardInfo.reward_guid)
}
inline ::KWMsg::Ident* BTLRewardInfo::release_reward_guid() {
...
inline ::KWMsg::Ident* BTLRewardInfo::unsafe_arena_release_reward_guid() {
  // @@protoc_insertion_point(field_release:KWMsg.BTLRewardInfo.reward_guid)
  
  ::KWMsg::Ident* temp = reward_guid_;
  reward_guid_ = nullptr;
  return temp;
}
inline ::KWMsg::Ident* BTLRewardInfo::_internal_mutable_reward_guid() {
...
inline ::KWMsg::Ident* BTLRewardInfo::mutable_reward_guid() {
  // @@protoc_insertion_point(field_mutable:KWMsg.BTLRewardInfo.reward_guid)
  return _internal_mutable_reward_guid();
}
inline void BTLRewardInfo::set_allocated_reward_guid(::KWMsg::Ident* reward_guid) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(reward_guid_);
  }
  if (reward_guid) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(reward_guid));
    if (message_arena != submessage_arena) {
  ...
  reward_guid_ = reward_guid;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.BTLRewardInfo.reward_guid)
}
...
// repeated .KWMsg.BTLRewardInfo extra_reward_list = 8;
inline int AckBTLEndInfo::_internal_extra_reward_list_size() const {
  return extra_reward_list_.size();
}
inline int AckBTLEndInfo::extra_reward_list_size() const {
  return _internal_extra_reward_list_size();
}
inline void AckBTLEndInfo::clear_extra_reward_list() {
  extra_reward_list_.Clear();
}
inline ::KWMsg::BTLRewardInfo* AckBTLEndInfo::mutable_extra_reward_list(int index) {
  // @@protoc_insertion_point(field_mutable:KWMsg.AckBTLEndInfo.extra_reward_list)
  return extra_reward_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::BTLRewardInfo >*
AckBTLEndInfo::mutable_extra_reward_list() {
  // @@protoc_insertion_point(field_mutable_list:KWMsg.AckBTLEndInfo.extra_reward_list)
  return &extra_reward_list_;
}
inline const ::KWMsg::BTLRewardInfo& AckBTLEndInfo::_internal_extra_reward_list(int index) const {
  return extra_reward_list_.Get(index);
}
inline const ::KWMsg::BTLRewardInfo& AckBTLEndInfo::extra_reward_list(int index) const {
  // @@protoc_insertion_point(field_get:KWMsg.AckBTLEndInfo.extra_reward_list)
  return _internal_extra_reward_list(index);
}
inline ::KWMsg::BTLRewardInfo* AckBTLEndInfo::_internal_add_extra_reward_list() {
  return extra_reward_list_.Add();
}
inline ::KWMsg::BTLRewardInfo* AckBTLEndInfo::add_extra_reward_list() {
  // @@protoc_insertion_point(field_add:KWMsg.AckBTLEndInfo.extra_reward_list)
  return _internal_add_extra_reward_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::BTLRewardInfo >&
AckBTLEndInfo::extra_reward_list() const {
  // @@protoc_insertion_point(field_list:KWMsg.AckBTLEndInfo.extra_reward_list)
  return extra_reward_list_;
}
