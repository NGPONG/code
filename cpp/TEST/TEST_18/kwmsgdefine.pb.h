...
enum EGameEventCode : int {
  ...
  BTL_TARGET_DEAD = 161,
  PLAYER_NAME_INVALID_FORMAT = 162,
  PLAYER_NAME_INVALID_WORDS = 163,
  PLAYER_NAME_INVALID_LENGTH = 164,
  PLAYER_NAME_EXIST = 165,
...
constexpr EGameEventCode EGameEventCode_MAX = PLAYER_NAME_EXIST;
...
enum EGameMsgID : int {
  ...
  REQ_ADD_PLAYER_NAME = 430,
  ACK_ADD_PLAYER_NAME = 431,
  REQ_RECORD = 1000,
  ACK_RECORD = 1001,
  ...
  REQ_INIT_MAIN_ROLE_NAME = 1010,
  ACK_INIT_MAIN_ROLE_NAME = 1011,
