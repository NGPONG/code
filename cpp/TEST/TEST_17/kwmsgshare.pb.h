...
class NGPONGTestPkg;
struct NGPONGTestPkgDefaultTypeInternal;
extern NGPONGTestPkgDefaultTypeInternal _NGPONGTestPkg_default_instance_;
class NGPONGTestPkg_NGPONGTestSubPkg;
struct NGPONGTestPkg_NGPONGTestSubPkgDefaultTypeInternal;
extern NGPONGTestPkg_NGPONGTestSubPkgDefaultTypeInternal _NGPONGTestPkg_NGPONGTestSubPkg_default_instance_;
...
template<> ::KWMsg::NGPONGTestPkg* Arena::CreateMaybeMessage<::KWMsg::NGPONGTestPkg>(Arena*);
template<> ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg* Arena::CreateMaybeMessage<::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg>(Arena*);
...
class ReqEnterBattle final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_game_id();
...
class NGPONGTestPkg_NGPONGTestSubPkg final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg) */ {
 public:
  inline NGPONGTestPkg_NGPONGTestSubPkg() : NGPONGTestPkg_NGPONGTestSubPkg(nullptr) {}
  ~NGPONGTestPkg_NGPONGTestSubPkg() override;
  explicit constexpr NGPONGTestPkg_NGPONGTestSubPkg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  NGPONGTestPkg_NGPONGTestSubPkg(const NGPONGTestPkg_NGPONGTestSubPkg& from);
  NGPONGTestPkg_NGPONGTestSubPkg(NGPONGTestPkg_NGPONGTestSubPkg&& from) noexcept
    : NGPONGTestPkg_NGPONGTestSubPkg() {
    *this = ::std::move(from);
  }

  inline NGPONGTestPkg_NGPONGTestSubPkg& operator=(const NGPONGTestPkg_NGPONGTestSubPkg& from) {
    CopyFrom(from);
    return *this;
  }
  inline NGPONGTestPkg_NGPONGTestSubPkg& operator=(NGPONGTestPkg_NGPONGTestSubPkg&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const NGPONGTestPkg_NGPONGTestSubPkg& default_instance() {
    return *internal_default_instance();
  }
  static inline const NGPONGTestPkg_NGPONGTestSubPkg* internal_default_instance() {
    return reinterpret_cast<const NGPONGTestPkg_NGPONGTestSubPkg*>(
               &_NGPONGTestPkg_NGPONGTestSubPkg_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    33;

  friend void swap(NGPONGTestPkg_NGPONGTestSubPkg& a, NGPONGTestPkg_NGPONGTestSubPkg& b) {
    a.Swap(&b);
  }
  inline void Swap(NGPONGTestPkg_NGPONGTestSubPkg* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(NGPONGTestPkg_NGPONGTestSubPkg* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline NGPONGTestPkg_NGPONGTestSubPkg* New() const final {
    return new NGPONGTestPkg_NGPONGTestSubPkg();
  }

  NGPONGTestPkg_NGPONGTestSubPkg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<NGPONGTestPkg_NGPONGTestSubPkg>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const NGPONGTestPkg_NGPONGTestSubPkg& from);
  void MergeFrom(const NGPONGTestPkg_NGPONGTestSubPkg& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(NGPONGTestPkg_NGPONGTestSubPkg* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "KWMsg.NGPONGTestPkg.NGPONGTestSubPkg";
  }
  protected:
  explicit NGPONGTestPkg_NGPONGTestSubPkg(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg)
 private:
  class _Internal;
...
class NGPONGTestPkg final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KWMsg.NGPONGTestPkg) */ {
 public:
  inline NGPONGTestPkg() : NGPONGTestPkg(nullptr) {}
  ~NGPONGTestPkg() override;
  explicit constexpr NGPONGTestPkg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  NGPONGTestPkg(const NGPONGTestPkg& from);
  NGPONGTestPkg(NGPONGTestPkg&& from) noexcept
    : NGPONGTestPkg() {
    *this = ::std::move(from);
  }

  inline NGPONGTestPkg& operator=(const NGPONGTestPkg& from) {
    CopyFrom(from);
    return *this;
  }
  inline NGPONGTestPkg& operator=(NGPONGTestPkg&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const NGPONGTestPkg& default_instance() {
    return *internal_default_instance();
  }
  static inline const NGPONGTestPkg* internal_default_instance() {
    return reinterpret_cast<const NGPONGTestPkg*>(
               &_NGPONGTestPkg_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    34;

  friend void swap(NGPONGTestPkg& a, NGPONGTestPkg& b) {
    a.Swap(&b);
  }
  inline void Swap(NGPONGTestPkg* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(NGPONGTestPkg* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline NGPONGTestPkg* New() const final {
    return new NGPONGTestPkg();
  }

  NGPONGTestPkg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<NGPONGTestPkg>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const NGPONGTestPkg& from);
  void MergeFrom(const NGPONGTestPkg& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(NGPONGTestPkg* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "KWMsg.NGPONGTestPkg";
  }
  protected:
  explicit NGPONGTestPkg(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  typedef NGPONGTestPkg_NGPONGTestSubPkg NGPONGTestSubPkg;
  ...
  // repeated .KWMsg.NGPONGTestPkg.NGPONGTestSubPkg list = 3;
  int list_size() const;
  private:
  int _internal_list_size() const;
  public:
  void clear_list();
  ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg* mutable_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg >*
      mutable_list();
  private:
  const ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg& _internal_list(int index) const;
  ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg* _internal_add_list();
  public:
  const ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg& list(int index) const;
  ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg* add_list();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg >&
      list() const;
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_data_1(ArgT0&& arg0, ArgT... args);
  std::string* mutable_data_1();
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_data_1();
  void set_allocated_data_1(std::string* data_1);
  private:
  const std::string& _internal_data_1() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_data_1(const std::string& value);
  std::string* _internal_mutable_data_1();
  public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_data_2(ArgT0&& arg0, ArgT... args);
  std::string* mutable_data_2();
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_data_2();
  void set_allocated_data_2(std::string* data_2);
  private:
  const std::string& _internal_data_2() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_data_2(const std::string& value);
  std::string* _internal_mutable_data_2();
  public:

  // @@protoc_insertion_point(class_scope:KWMsg.NGPONGTestPkg)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg > list_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr data_1_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr data_2_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_kwmsgshare_2eproto;
};
// ===================================================================
...
// bytes game_id = 2;
inline void ReqEnterBattle::clear_game_id() {
  game_id_.ClearToEmpty();
}
inline const std::string& ReqEnterBattle::game_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqEnterBattle.game_id)
  return _internal_game_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ReqEnterBattle::set_game_id(ArgT0&& arg0, ArgT... args) {
 
 game_id_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.ReqEnterBattle.game_id)
}
inline std::string* ReqEnterBattle::mutable_game_id() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ReqEnterBattle.game_id)
  return _internal_mutable_game_id();
}
inline const std::string& ReqEnterBattle::_internal_game_id() const {
  return game_id_.Get();
}
inline void ReqEnterBattle::_internal_set_game_id(const std::string& value) {
  
  game_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ReqEnterBattle::_internal_mutable_game_id() {
  
  return game_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ReqEnterBattle::release_game_id() {
  // @@protoc_insertion_point(field_release:KWMsg.ReqEnterBattle.game_id)
  return game_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void ReqEnterBattle::set_allocated_game_id(std::string* game_id) {
  if (game_id != nullptr) {
    
  } else {
    
  }
  game_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), game_id,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ReqEnterBattle.game_id)
}
...
// bytes game_id = 2;
inline void AckEnterBattle::clear_game_id() {
  game_id_.ClearToEmpty();
}
inline const std::string& AckEnterBattle::game_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.AckEnterBattle.game_id)
  return _internal_game_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AckEnterBattle::set_game_id(ArgT0&& arg0, ArgT... args) {
 
 game_id_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.AckEnterBattle.game_id)
}
inline std::string* AckEnterBattle::mutable_game_id() {
  // @@protoc_insertion_point(field_mutable:KWMsg.AckEnterBattle.game_id)
  return _internal_mutable_game_id();
}
inline const std::string& AckEnterBattle::_internal_game_id() const {
  return game_id_.Get();
}
inline void AckEnterBattle::_internal_set_game_id(const std::string& value) {
  
  game_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* AckEnterBattle::_internal_mutable_game_id() {
  
  return game_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* AckEnterBattle::release_game_id() {
  // @@protoc_insertion_point(field_release:KWMsg.AckEnterBattle.game_id)
  return game_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void AckEnterBattle::set_allocated_game_id(std::string* game_id) {
  if (game_id != nullptr) {
  ...
  game_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), game_id,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.AckEnterBattle.game_id)
}
...
// .KWMsg.Ident player_id = 1;
inline bool NGPONGTestPkg_NGPONGTestSubPkg::_internal_has_player_id() const {
  return this != internal_default_instance() && player_id_ != nullptr;
}
inline bool NGPONGTestPkg_NGPONGTestSubPkg::has_player_id() const {
  return _internal_has_player_id();
}
inline const ::KWMsg::Ident& NGPONGTestPkg_NGPONGTestSubPkg::_internal_player_id() const {
  const ::KWMsg::Ident* p = player_id_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::Ident&>(
      ::KWMsg::_Ident_default_instance_);
}
inline const ::KWMsg::Ident& NGPONGTestPkg_NGPONGTestSubPkg::player_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg.player_id)
  return _internal_player_id();
}
inline void NGPONGTestPkg_NGPONGTestSubPkg::unsafe_arena_set_allocated_player_id(
    ::KWMsg::Ident* player_id) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(player_id_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg.player_id)
}
inline ::KWMsg::Ident* NGPONGTestPkg_NGPONGTestSubPkg::release_player_id() {
...
inline ::KWMsg::Ident* NGPONGTestPkg_NGPONGTestSubPkg::unsafe_arena_release_player_id() {
  // @@protoc_insertion_point(field_release:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg.player_id)
  
  ::KWMsg::Ident* temp = player_id_;
  player_id_ = nullptr;
  return temp;
}
inline ::KWMsg::Ident* NGPONGTestPkg_NGPONGTestSubPkg::_internal_mutable_player_id() {
...
inline ::KWMsg::Ident* NGPONGTestPkg_NGPONGTestSubPkg::mutable_player_id() {
  // @@protoc_insertion_point(field_mutable:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg.player_id)
  return _internal_mutable_player_id();
}
inline void NGPONGTestPkg_NGPONGTestSubPkg::set_allocated_player_id(::KWMsg::Ident* player_id) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(player_id_);
  }
  ...
  player_id_ = player_id;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg.player_id)
}

// int64 score = 2;
inline void NGPONGTestPkg_NGPONGTestSubPkg::clear_score() {
  score_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 NGPONGTestPkg_NGPONGTestSubPkg::_internal_score() const {
  return score_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 NGPONGTestPkg_NGPONGTestSubPkg::score() const {
  // @@protoc_insertion_point(field_get:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg.score)
  return _internal_score();
}
inline void NGPONGTestPkg_NGPONGTestSubPkg::_internal_set_score(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  score_ = value;
}
inline void NGPONGTestPkg_NGPONGTestSubPkg::set_score(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_score(value);
  // @@protoc_insertion_point(field_set:KWMsg.NGPONGTestPkg.NGPONGTestSubPkg.score)
}
...
// bytes data_1 = 1;
inline void NGPONGTestPkg::clear_data_1() {
  data_1_.ClearToEmpty();
}
inline const std::string& NGPONGTestPkg::data_1() const {
  // @@protoc_insertion_point(field_get:KWMsg.NGPONGTestPkg.data_1)
  return _internal_data_1();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void NGPONGTestPkg::set_data_1(ArgT0&& arg0, ArgT... args) {
 
 data_1_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.NGPONGTestPkg.data_1)
}
inline std::string* NGPONGTestPkg::mutable_data_1() {
  // @@protoc_insertion_point(field_mutable:KWMsg.NGPONGTestPkg.data_1)
  return _internal_mutable_data_1();
}
inline const std::string& NGPONGTestPkg::_internal_data_1() const {
  return data_1_.Get();
}
inline void NGPONGTestPkg::_internal_set_data_1(const std::string& value) {
  
  data_1_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* NGPONGTestPkg::_internal_mutable_data_1() {
  
  return data_1_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* NGPONGTestPkg::release_data_1() {
  // @@protoc_insertion_point(field_release:KWMsg.NGPONGTestPkg.data_1)
  return data_1_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void NGPONGTestPkg::set_allocated_data_1(std::string* data_1) {
  if (data_1 != nullptr) {
    
  } else {
    
  }
  data_1_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data_1,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.NGPONGTestPkg.data_1)
}

// bytes data_2 = 2;
inline void NGPONGTestPkg::clear_data_2() {
  data_2_.ClearToEmpty();
}
inline const std::string& NGPONGTestPkg::data_2() const {
  // @@protoc_insertion_point(field_get:KWMsg.NGPONGTestPkg.data_2)
  return _internal_data_2();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void NGPONGTestPkg::set_data_2(ArgT0&& arg0, ArgT... args) {
 
 data_2_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.NGPONGTestPkg.data_2)
}
inline std::string* NGPONGTestPkg::mutable_data_2() {
  // @@protoc_insertion_point(field_mutable:KWMsg.NGPONGTestPkg.data_2)
  return _internal_mutable_data_2();
}
inline const std::string& NGPONGTestPkg::_internal_data_2() const {
  return data_2_.Get();
}
inline void NGPONGTestPkg::_internal_set_data_2(const std::string& value) {
  
  data_2_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* NGPONGTestPkg::_internal_mutable_data_2() {
  
  return data_2_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* NGPONGTestPkg::release_data_2() {
  // @@protoc_insertion_point(field_release:KWMsg.NGPONGTestPkg.data_2)
  return data_2_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void NGPONGTestPkg::set_allocated_data_2(std::string* data_2) {
  if (data_2 != nullptr) {
    
  } else {
    
  }
  data_2_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data_2,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.NGPONGTestPkg.data_2)
}

// repeated .KWMsg.NGPONGTestPkg.NGPONGTestSubPkg list = 3;
inline int NGPONGTestPkg::_internal_list_size() const {
  return list_.size();
}
inline int NGPONGTestPkg::list_size() const {
  return _internal_list_size();
}
inline void NGPONGTestPkg::clear_list() {
  list_.Clear();
}
inline ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg* NGPONGTestPkg::mutable_list(int index) {
  // @@protoc_insertion_point(field_mutable:KWMsg.NGPONGTestPkg.list)
  return list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg >*
NGPONGTestPkg::mutable_list() {
  // @@protoc_insertion_point(field_mutable_list:KWMsg.NGPONGTestPkg.list)
  return &list_;
}
inline const ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg& NGPONGTestPkg::_internal_list(int index) const {
  return list_.Get(index);
}
inline const ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg& NGPONGTestPkg::list(int index) const {
  // @@protoc_insertion_point(field_get:KWMsg.NGPONGTestPkg.list)
  return _internal_list(index);
}
inline ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg* NGPONGTestPkg::_internal_add_list() {
  return list_.Add();
}
inline ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg* NGPONGTestPkg::add_list() {
  // @@protoc_insertion_point(field_add:KWMsg.NGPONGTestPkg.list)
  return _internal_add_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KWMsg::NGPONGTestPkg_NGPONGTestSubPkg >&
NGPONGTestPkg::list() const {
  // @@protoc_insertion_point(field_list:KWMsg.NGPONGTestPkg.list)
  return list_;
}
