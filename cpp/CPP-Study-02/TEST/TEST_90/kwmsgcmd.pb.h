...
namespace KWMsg {
class AckCmdExecute;
struct AckCmdExecuteDefaultTypeInternal;
extern AckCmdExecuteDefaultTypeInternal _AckCmdExecute_default_instance_;
class AckGmCmdWhiteList;
struct AckGmCmdWhiteListDefaultTypeInternal;
extern AckGmCmdWhiteListDefaultTypeInternal _AckGmCmdWhiteList_default_instance_;
...
class ReqGmCmdWhiteList;
struct ReqGmCmdWhiteListDefaultTypeInternal;
extern ReqGmCmdWhiteListDefaultTypeInternal _ReqGmCmdWhiteList_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::KWMsg::AckCmdExecute* Arena::CreateMaybeMessage<::KWMsg::AckCmdExecute>(Arena*);
template<> ::KWMsg::AckGmCmdWhiteList* Arena::CreateMaybeMessage<::KWMsg::AckGmCmdWhiteList>(Arena*);
...
template<> ::KWMsg::ReqGmCmdWhiteList* Arena::CreateMaybeMessage<::KWMsg::ReqGmCmdWhiteList>(Arena*);
...
enum EGmWhiteListOperation : int {
  EGWLO_QUERY = 0,
  EGWLO_ADD = 1,
  EGWLO_DELETE = 2,
  EGmWhiteListOperation_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  EGmWhiteListOperation_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool EGmWhiteListOperation_IsValid(int value);
constexpr EGmWhiteListOperation EGmWhiteListOperation_MIN = EGWLO_QUERY;
constexpr EGmWhiteListOperation EGmWhiteListOperation_MAX = EGWLO_DELETE;
constexpr int EGmWhiteListOperation_ARRAYSIZE = EGmWhiteListOperation_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EGmWhiteListOperation_descriptor();
template<typename T>
inline const std::string& EGmWhiteListOperation_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EGmWhiteListOperation>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EGmWhiteListOperation_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EGmWhiteListOperation_descriptor(), enum_t_value);
}
inline bool EGmWhiteListOperation_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EGmWhiteListOperation* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EGmWhiteListOperation>(
    EGmWhiteListOperation_descriptor(), name, value);
}
// ===================================================================
...
class AckCmdExecute final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KWMsg.AckCmdExecute) */ {
 public:
  inline AckCmdExecute() : AckCmdExecute(nullptr) {}
  ~AckCmdExecute() override;
  explicit constexpr AckCmdExecute(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AckCmdExecute(const AckCmdExecute& from);
  AckCmdExecute(AckCmdExecute&& from) noexcept
    : AckCmdExecute() {
    *this = ::std::move(from);
  }

  inline AckCmdExecute& operator=(const AckCmdExecute& from) {
    CopyFrom(from);
    return *this;
  }
  inline AckCmdExecute& operator=(AckCmdExecute&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const AckCmdExecute& default_instance() {
    return *internal_default_instance();
  }
  static inline const AckCmdExecute* internal_default_instance() {
    return reinterpret_cast<const AckCmdExecute*>(
               &_AckCmdExecute_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(AckCmdExecute& a, AckCmdExecute& b) {
    a.Swap(&b);
  }
  inline void Swap(AckCmdExecute* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(AckCmdExecute* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline AckCmdExecute* New() const final {
    return new AckCmdExecute();
  }

  AckCmdExecute* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AckCmdExecute>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AckCmdExecute& from);
  void MergeFrom(const AckCmdExecute& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AckCmdExecute* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "KWMsg.AckCmdExecute";
  }
  protected:
  explicit AckCmdExecute(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:KWMsg.AckCmdExecute)
 private:
  class _Internal;
...
class ReqGmCmdWhiteList final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KWMsg.ReqGmCmdWhiteList) */ {
 public:
  inline ReqGmCmdWhiteList() : ReqGmCmdWhiteList(nullptr) {}
  ~ReqGmCmdWhiteList() override;
  explicit constexpr ReqGmCmdWhiteList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ReqGmCmdWhiteList(const ReqGmCmdWhiteList& from);
  ReqGmCmdWhiteList(ReqGmCmdWhiteList&& from) noexcept
    : ReqGmCmdWhiteList() {
    *this = ::std::move(from);
  }

  inline ReqGmCmdWhiteList& operator=(const ReqGmCmdWhiteList& from) {
    CopyFrom(from);
    return *this;
  }
  inline ReqGmCmdWhiteList& operator=(ReqGmCmdWhiteList&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const ReqGmCmdWhiteList& default_instance() {
    return *internal_default_instance();
  }
  static inline const ReqGmCmdWhiteList* internal_default_instance() {
    return reinterpret_cast<const ReqGmCmdWhiteList*>(
               &_ReqGmCmdWhiteList_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    16;

  friend void swap(ReqGmCmdWhiteList& a, ReqGmCmdWhiteList& b) {
    a.Swap(&b);
  }
  inline void Swap(ReqGmCmdWhiteList* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ReqGmCmdWhiteList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline ReqGmCmdWhiteList* New() const final {
    return new ReqGmCmdWhiteList();
  }

  ReqGmCmdWhiteList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ReqGmCmdWhiteList>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ReqGmCmdWhiteList& from);
  void MergeFrom(const ReqGmCmdWhiteList& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ReqGmCmdWhiteList* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "KWMsg.ReqGmCmdWhiteList";
  }
  protected:
  explicit ReqGmCmdWhiteList(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_accounts(ArgT0&& arg0, ArgT... args);
  std::string* mutable_accounts();
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_accounts();
  void set_allocated_accounts(std::string* accounts);
  private:
  const std::string& _internal_accounts() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_accounts(const std::string& value);
  ...
  // int32 feedback = 4;
  void clear_feedback();
  ::PROTOBUF_NAMESPACE_ID::int32 feedback() const;
  void set_feedback(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_feedback() const;
  void _internal_set_feedback(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:KWMsg.ReqGmCmdWhiteList)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 feedback_;
  ::PROTOBUF_NAMESPACE_ID::int64 req_id_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_kwmsgcmd_2eproto;
};
...
class AckGmCmdWhiteList final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:KWMsg.AckGmCmdWhiteList) */ {
 public:
  inline AckGmCmdWhiteList() : AckGmCmdWhiteList(nullptr) {}
  ~AckGmCmdWhiteList() override;
  explicit constexpr AckGmCmdWhiteList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AckGmCmdWhiteList(const AckGmCmdWhiteList& from);
  AckGmCmdWhiteList(AckGmCmdWhiteList&& from) noexcept
    : AckGmCmdWhiteList() {
    *this = ::std::move(from);
  }

  inline AckGmCmdWhiteList& operator=(const AckGmCmdWhiteList& from) {
    CopyFrom(from);
    return *this;
  }
  inline AckGmCmdWhiteList& operator=(AckGmCmdWhiteList&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const AckGmCmdWhiteList& default_instance() {
    return *internal_default_instance();
  }
  static inline const AckGmCmdWhiteList* internal_default_instance() {
    return reinterpret_cast<const AckGmCmdWhiteList*>(
               &_AckGmCmdWhiteList_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    17;

  friend void swap(AckGmCmdWhiteList& a, AckGmCmdWhiteList& b) {
    a.Swap(&b);
  }
  inline void Swap(AckGmCmdWhiteList* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(AckGmCmdWhiteList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline AckGmCmdWhiteList* New() const final {
    return new AckGmCmdWhiteList();
  }

  AckGmCmdWhiteList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AckGmCmdWhiteList>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AckGmCmdWhiteList& from);
  void MergeFrom(const AckGmCmdWhiteList& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AckGmCmdWhiteList* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "KWMsg.AckGmCmdWhiteList";
  }
  protected:
  explicit AckGmCmdWhiteList(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:KWMsg.AckGmCmdWhiteList)
 private:
  class _Internal;
...
// int32 ret = 1;
inline void AckCmdExecute::clear_ret() {
  ret_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AckCmdExecute::_internal_ret() const {
  return ret_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AckCmdExecute::ret() const {
  // @@protoc_insertion_point(field_get:KWMsg.AckCmdExecute.ret)
  return _internal_ret();
}
inline void AckCmdExecute::_internal_set_ret(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  ret_ = value;
}
inline void AckCmdExecute::set_ret(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_ret(value);
  // @@protoc_insertion_point(field_set:KWMsg.AckCmdExecute.ret)
}

// int64 req_id = 2;
inline void AckCmdExecute::clear_req_id() {
  req_id_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AckCmdExecute::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AckCmdExecute::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.AckCmdExecute.req_id)
  return _internal_req_id();
}
inline void AckCmdExecute::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  req_id_ = value;
}
inline void AckCmdExecute::set_req_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.AckCmdExecute.req_id)
}
...
// int32 req_id = 4;
inline void ReqGmSetProperty::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSetProperty::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSetProperty::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmSetProperty.req_id)
  return _internal_req_id();
}
inline void ReqGmSetProperty::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmSetProperty::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmSetProperty.req_id)
}
...
// int32 req_id = 4;
inline void ReqGmOpenFunction::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmOpenFunction::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmOpenFunction::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmOpenFunction.req_id)
  return _internal_req_id();
}
inline void ReqGmOpenFunction::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmOpenFunction::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmOpenFunction.req_id)
}
...
// int32 req_id = 3;
inline void ReqGmAddResources::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmAddResources::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmAddResources::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmAddResources.req_id)
  return _internal_req_id();
}
inline void ReqGmAddResources::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmAddResources::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmAddResources.req_id)
}
...
// int32 req_id = 4;
inline void ReqGmEnterBattle::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmEnterBattle::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmEnterBattle::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmEnterBattle.req_id)
  return _internal_req_id();
}
inline void ReqGmEnterBattle::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmEnterBattle::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmEnterBattle.req_id)
}
...
// int32 req_id = 3;
inline void ReqGmEndBattle::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmEndBattle::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmEndBattle::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmEndBattle.req_id)
  return _internal_req_id();
}
inline void ReqGmEndBattle::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmEndBattle::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmEndBattle.req_id)
}
...
// int32 req_id = 3;
inline void ReqGmChatMuzzle::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmChatMuzzle::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmChatMuzzle::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmChatMuzzle.req_id)
  return _internal_req_id();
}
inline void ReqGmChatMuzzle::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmChatMuzzle::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmChatMuzzle.req_id)
}
...
// int32 req_id = 4;
inline void ReqGmSetGuideGroup::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSetGuideGroup::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSetGuideGroup::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmSetGuideGroup.req_id)
  return _internal_req_id();
}
inline void ReqGmSetGuideGroup::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmSetGuideGroup::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmSetGuideGroup.req_id)
}
...
// int32 req_id = 2;
inline void ReqGmSendNotificationEvent::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSendNotificationEvent::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSendNotificationEvent::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmSendNotificationEvent.req_id)
  return _internal_req_id();
}
inline void ReqGmSendNotificationEvent::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmSendNotificationEvent::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmSendNotificationEvent.req_id)
}
...
// int32 req_id = 4;
inline void ReqGmTriggerEvent::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmTriggerEvent::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmTriggerEvent::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmTriggerEvent.req_id)
  return _internal_req_id();
}
inline void ReqGmTriggerEvent::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmTriggerEvent::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmTriggerEvent.req_id)
}
...
// int32 req_id = 7;
inline void ReqGmSetRecord::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSetRecord::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmSetRecord::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmSetRecord.req_id)
  return _internal_req_id();
}
inline void ReqGmSetRecord::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmSetRecord::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmSetRecord.req_id)
}
...
// int32 req_id = 2;
inline void ReqGmCmdDebugAccount::clear_req_id() {
  req_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmCmdDebugAccount::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmCmdDebugAccount::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmCmdDebugAccount.req_id)
  return _internal_req_id();
}
inline void ReqGmCmdDebugAccount::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  req_id_ = value;
}
inline void ReqGmCmdDebugAccount::set_req_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmCmdDebugAccount.req_id)
}
...
// int32 op_type = 1;
inline void ReqGmCmdWhiteList::clear_op_type() {
  op_type_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmCmdWhiteList::_internal_op_type() const {
  return op_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmCmdWhiteList::op_type() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmCmdWhiteList.op_type)
  return _internal_op_type();
}
inline void ReqGmCmdWhiteList::_internal_set_op_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  op_type_ = value;
}
inline void ReqGmCmdWhiteList::set_op_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_op_type(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmCmdWhiteList.op_type)
}

// bytes accounts = 2;
inline void ReqGmCmdWhiteList::clear_accounts() {
  accounts_.ClearToEmpty();
}
inline const std::string& ReqGmCmdWhiteList::accounts() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmCmdWhiteList.accounts)
  return _internal_accounts();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ReqGmCmdWhiteList::set_accounts(ArgT0&& arg0, ArgT... args) {
 
 accounts_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmCmdWhiteList.accounts)
}
inline std::string* ReqGmCmdWhiteList::mutable_accounts() {
  // @@protoc_insertion_point(field_mutable:KWMsg.ReqGmCmdWhiteList.accounts)
  return _internal_mutable_accounts();
}
inline const std::string& ReqGmCmdWhiteList::_internal_accounts() const {
  return accounts_.Get();
}
inline void ReqGmCmdWhiteList::_internal_set_accounts(const std::string& value) {
  
  accounts_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ReqGmCmdWhiteList::_internal_mutable_accounts() {
  
  return accounts_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ReqGmCmdWhiteList::release_accounts() {
  // @@protoc_insertion_point(field_release:KWMsg.ReqGmCmdWhiteList.accounts)
  return accounts_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void ReqGmCmdWhiteList::set_allocated_accounts(std::string* accounts) {
  if (accounts != nullptr) {
  ...
  accounts_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), accounts,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.ReqGmCmdWhiteList.accounts)
}

// int64 req_id = 3;
inline void ReqGmCmdWhiteList::clear_req_id() {
  req_id_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 ReqGmCmdWhiteList::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 ReqGmCmdWhiteList::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmCmdWhiteList.req_id)
  return _internal_req_id();
}
inline void ReqGmCmdWhiteList::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  req_id_ = value;
}
inline void ReqGmCmdWhiteList::set_req_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmCmdWhiteList.req_id)
}

// int32 feedback = 4;
inline void ReqGmCmdWhiteList::clear_feedback() {
  feedback_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmCmdWhiteList::_internal_feedback() const {
  return feedback_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReqGmCmdWhiteList::feedback() const {
  // @@protoc_insertion_point(field_get:KWMsg.ReqGmCmdWhiteList.feedback)
  return _internal_feedback();
}
inline void ReqGmCmdWhiteList::_internal_set_feedback(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  feedback_ = value;
}
inline void ReqGmCmdWhiteList::set_feedback(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_feedback(value);
  // @@protoc_insertion_point(field_set:KWMsg.ReqGmCmdWhiteList.feedback)
}
...
// int32 op_type = 1;
inline void AckGmCmdWhiteList::clear_op_type() {
  op_type_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AckGmCmdWhiteList::_internal_op_type() const {
  return op_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AckGmCmdWhiteList::op_type() const {
  // @@protoc_insertion_point(field_get:KWMsg.AckGmCmdWhiteList.op_type)
  return _internal_op_type();
}
inline void AckGmCmdWhiteList::_internal_set_op_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  op_type_ = value;
}
inline void AckGmCmdWhiteList::set_op_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_op_type(value);
  // @@protoc_insertion_point(field_set:KWMsg.AckGmCmdWhiteList.op_type)
}

// bytes accounts = 2;
inline void AckGmCmdWhiteList::clear_accounts() {
  accounts_.ClearToEmpty();
}
inline const std::string& AckGmCmdWhiteList::accounts() const {
  // @@protoc_insertion_point(field_get:KWMsg.AckGmCmdWhiteList.accounts)
  return _internal_accounts();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AckGmCmdWhiteList::set_accounts(ArgT0&& arg0, ArgT... args) {
 
 accounts_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.AckGmCmdWhiteList.accounts)
}
inline std::string* AckGmCmdWhiteList::mutable_accounts() {
  // @@protoc_insertion_point(field_mutable:KWMsg.AckGmCmdWhiteList.accounts)
  return _internal_mutable_accounts();
}
inline const std::string& AckGmCmdWhiteList::_internal_accounts() const {
  return accounts_.Get();
}
inline void AckGmCmdWhiteList::_internal_set_accounts(const std::string& value) {
  
  accounts_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* AckGmCmdWhiteList::_internal_mutable_accounts() {
  
  return accounts_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* AckGmCmdWhiteList::release_accounts() {
  // @@protoc_insertion_point(field_release:KWMsg.AckGmCmdWhiteList.accounts)
  return accounts_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void AckGmCmdWhiteList::set_allocated_accounts(std::string* accounts) {
  if (accounts != nullptr) {
  ...
  accounts_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), accounts,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.AckGmCmdWhiteList.accounts)
}

// int64 req_id = 3;
inline void AckGmCmdWhiteList::clear_req_id() {
  req_id_ = int64_t{0};
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AckGmCmdWhiteList::_internal_req_id() const {
  return req_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AckGmCmdWhiteList::req_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.AckGmCmdWhiteList.req_id)
  return _internal_req_id();
}
inline void AckGmCmdWhiteList::_internal_set_req_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  req_id_ = value;
}
inline void AckGmCmdWhiteList::set_req_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_req_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.AckGmCmdWhiteList.req_id)
}
...
template <> struct is_proto_enum< ::KWMsg::EGmWhiteListOperation> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::KWMsg::EGmWhiteListOperation>() {
  return ::KWMsg::EGmWhiteListOperation_descriptor();
}
