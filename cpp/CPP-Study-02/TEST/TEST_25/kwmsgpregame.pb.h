...
class AckVerifyJwt final :
 ...
 public:
  ...
  enum : int {
    kSecurityKeyFieldNumber = 2,
    kSecurityIvFieldNumber = 3,
...
// bytes nickname = 7;
inline void PlayerOnlineNotify::clear_nickname() {
  nickname_.ClearToEmpty();
}
inline const std::string& PlayerOnlineNotify::nickname() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOnlineNotify.nickname)
  return _internal_nickname();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerOnlineNotify::set_nickname(ArgT0&& arg0, ArgT... args) {
 
 nickname_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOnlineNotify.nickname)
}
inline std::string* PlayerOnlineNotify::mutable_nickname() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOnlineNotify.nickname)
  return _internal_mutable_nickname();
}
inline const std::string& PlayerOnlineNotify::_internal_nickname() const {
  return nickname_.Get();
}
inline void PlayerOnlineNotify::_internal_set_nickname(const std::string& value) {
  
  nickname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerOnlineNotify::_internal_mutable_nickname() {
  
  return nickname_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerOnlineNotify::release_nickname() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOnlineNotify.nickname)
  return nickname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerOnlineNotify::set_allocated_nickname(std::string* nickname) {
  if (nickname != nullptr) {
  ...
  nickname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), nickname,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOnlineNotify.nickname)
}

// bytes avatar = 8;
inline void PlayerOnlineNotify::clear_avatar() {
  avatar_.ClearToEmpty();
}
inline const std::string& PlayerOnlineNotify::avatar() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOnlineNotify.avatar)
  return _internal_avatar();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerOnlineNotify::set_avatar(ArgT0&& arg0, ArgT... args) {
 
 avatar_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOnlineNotify.avatar)
}
inline std::string* PlayerOnlineNotify::mutable_avatar() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOnlineNotify.avatar)
  return _internal_mutable_avatar();
}
inline const std::string& PlayerOnlineNotify::_internal_avatar() const {
  return avatar_.Get();
}
inline void PlayerOnlineNotify::_internal_set_avatar(const std::string& value) {
  
  avatar_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerOnlineNotify::_internal_mutable_avatar() {
  
  return avatar_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerOnlineNotify::release_avatar() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOnlineNotify.avatar)
  return avatar_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerOnlineNotify::set_allocated_avatar(std::string* avatar) {
  if (avatar != nullptr) {
  ...
  avatar_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), avatar,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOnlineNotify.avatar)
}

// bytes avatar_frame = 9;
inline void PlayerOnlineNotify::clear_avatar_frame() {
  avatar_frame_.ClearToEmpty();
}
inline const std::string& PlayerOnlineNotify::avatar_frame() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOnlineNotify.avatar_frame)
  return _internal_avatar_frame();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerOnlineNotify::set_avatar_frame(ArgT0&& arg0, ArgT... args) {
 
 avatar_frame_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOnlineNotify.avatar_frame)
}
inline std::string* PlayerOnlineNotify::mutable_avatar_frame() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOnlineNotify.avatar_frame)
  return _internal_mutable_avatar_frame();
}
inline const std::string& PlayerOnlineNotify::_internal_avatar_frame() const {
  return avatar_frame_.Get();
}
inline void PlayerOnlineNotify::_internal_set_avatar_frame(const std::string& value) {
  
  avatar_frame_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerOnlineNotify::_internal_mutable_avatar_frame() {
  
  return avatar_frame_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerOnlineNotify::release_avatar_frame() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOnlineNotify.avatar_frame)
  return avatar_frame_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerOnlineNotify::set_allocated_avatar_frame(std::string* avatar_frame) {
  if (avatar_frame != nullptr) {
  ...
  avatar_frame_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), avatar_frame,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOnlineNotify.avatar_frame)
}

// int32 level = 10;
inline void PlayerOnlineNotify::clear_level() {
  level_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOnlineNotify::_internal_level() const {
  return level_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOnlineNotify::level() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOnlineNotify.level)
  return _internal_level();
}
inline void PlayerOnlineNotify::_internal_set_level(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  level_ = value;
}
inline void PlayerOnlineNotify::set_level(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_level(value);
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOnlineNotify.level)
}
...
// .KWMsg.Ident player_id = 1;
inline bool PlayerOfflineNotify::_internal_has_player_id() const {
  return this != internal_default_instance() && player_id_ != nullptr;
}
inline bool PlayerOfflineNotify::has_player_id() const {
  return _internal_has_player_id();
}
inline const ::KWMsg::Ident& PlayerOfflineNotify::_internal_player_id() const {
  const ::KWMsg::Ident* p = player_id_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::Ident&>(
      ::KWMsg::_Ident_default_instance_);
}
inline const ::KWMsg::Ident& PlayerOfflineNotify::player_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.player_id)
  return _internal_player_id();
}
inline void PlayerOfflineNotify::unsafe_arena_set_allocated_player_id(
    ::KWMsg::Ident* player_id) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(player_id_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.PlayerOfflineNotify.player_id)
}
inline ::KWMsg::Ident* PlayerOfflineNotify::release_player_id() {
...
inline ::KWMsg::Ident* PlayerOfflineNotify::unsafe_arena_release_player_id() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOfflineNotify.player_id)
  
  ::KWMsg::Ident* temp = player_id_;
  player_id_ = nullptr;
  return temp;
}
inline ::KWMsg::Ident* PlayerOfflineNotify::_internal_mutable_player_id() {
...
inline ::KWMsg::Ident* PlayerOfflineNotify::mutable_player_id() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOfflineNotify.player_id)
  return _internal_mutable_player_id();
}
inline void PlayerOfflineNotify::set_allocated_player_id(::KWMsg::Ident* player_id) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(player_id_);
  }
  ...
  player_id_ = player_id;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOfflineNotify.player_id)
}
...
// bytes digital_id = 3;
inline void PlayerOfflineNotify::clear_digital_id() {
  digital_id_.ClearToEmpty();
}
inline const std::string& PlayerOfflineNotify::digital_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.digital_id)
  return _internal_digital_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerOfflineNotify::set_digital_id(ArgT0&& arg0, ArgT... args) {
 
 digital_id_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOfflineNotify.digital_id)
}
inline std::string* PlayerOfflineNotify::mutable_digital_id() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOfflineNotify.digital_id)
  return _internal_mutable_digital_id();
}
inline const std::string& PlayerOfflineNotify::_internal_digital_id() const {
  return digital_id_.Get();
}
inline void PlayerOfflineNotify::_internal_set_digital_id(const std::string& value) {
  
  digital_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::_internal_mutable_digital_id() {
  
  return digital_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::release_digital_id() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOfflineNotify.digital_id)
  return digital_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerOfflineNotify::set_allocated_digital_id(std::string* digital_id) {
  if (digital_id != nullptr) {
  ...
  digital_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), digital_id,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOfflineNotify.digital_id)
}

// int32 game_id = 4;
inline void PlayerOfflineNotify::clear_game_id() {
  game_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOfflineNotify::_internal_game_id() const {
  return game_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOfflineNotify::game_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.game_id)
  return _internal_game_id();
}
inline void PlayerOfflineNotify::_internal_set_game_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  game_id_ = value;
}
inline void PlayerOfflineNotify::set_game_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_game_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOfflineNotify.game_id)
}

// int32 proxy_id = 5;
inline void PlayerOfflineNotify::clear_proxy_id() {
  proxy_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOfflineNotify::_internal_proxy_id() const {
  return proxy_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOfflineNotify::proxy_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.proxy_id)
  return _internal_proxy_id();
}
inline void PlayerOfflineNotify::_internal_set_proxy_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  proxy_id_ = value;
}
inline void PlayerOfflineNotify::set_proxy_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_proxy_id(value);
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOfflineNotify.proxy_id)
}

// .KWMsg.Ident client_id = 6;
inline bool PlayerOfflineNotify::_internal_has_client_id() const {
  return this != internal_default_instance() && client_id_ != nullptr;
}
inline bool PlayerOfflineNotify::has_client_id() const {
  return _internal_has_client_id();
}
inline const ::KWMsg::Ident& PlayerOfflineNotify::_internal_client_id() const {
  const ::KWMsg::Ident* p = client_id_;
  return p != nullptr ? *p : reinterpret_cast<const ::KWMsg::Ident&>(
      ::KWMsg::_Ident_default_instance_);
}
inline const ::KWMsg::Ident& PlayerOfflineNotify::client_id() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.client_id)
  return _internal_client_id();
}
inline void PlayerOfflineNotify::unsafe_arena_set_allocated_client_id(
    ::KWMsg::Ident* client_id) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(client_id_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:KWMsg.PlayerOfflineNotify.client_id)
}
inline ::KWMsg::Ident* PlayerOfflineNotify::release_client_id() {
...
inline ::KWMsg::Ident* PlayerOfflineNotify::unsafe_arena_release_client_id() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOfflineNotify.client_id)
  
  ::KWMsg::Ident* temp = client_id_;
  client_id_ = nullptr;
  return temp;
}
inline ::KWMsg::Ident* PlayerOfflineNotify::_internal_mutable_client_id() {
...
inline ::KWMsg::Ident* PlayerOfflineNotify::mutable_client_id() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOfflineNotify.client_id)
  return _internal_mutable_client_id();
}
inline void PlayerOfflineNotify::set_allocated_client_id(::KWMsg::Ident* client_id) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(client_id_);
  }
  ...
  client_id_ = client_id;
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOfflineNotify.client_id)
}

// bytes nickname = 7;
inline void PlayerOfflineNotify::clear_nickname() {
  nickname_.ClearToEmpty();
}
inline const std::string& PlayerOfflineNotify::nickname() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.nickname)
  return _internal_nickname();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerOfflineNotify::set_nickname(ArgT0&& arg0, ArgT... args) {
 
 nickname_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOfflineNotify.nickname)
}
inline std::string* PlayerOfflineNotify::mutable_nickname() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOfflineNotify.nickname)
  return _internal_mutable_nickname();
}
inline const std::string& PlayerOfflineNotify::_internal_nickname() const {
  return nickname_.Get();
}
inline void PlayerOfflineNotify::_internal_set_nickname(const std::string& value) {
  
  nickname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::_internal_mutable_nickname() {
  
  return nickname_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::release_nickname() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOfflineNotify.nickname)
  return nickname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerOfflineNotify::set_allocated_nickname(std::string* nickname) {
  if (nickname != nullptr) {
  ...
  nickname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), nickname,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOfflineNotify.nickname)
}

// bytes avatar = 8;
inline void PlayerOfflineNotify::clear_avatar() {
  avatar_.ClearToEmpty();
}
inline const std::string& PlayerOfflineNotify::avatar() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.avatar)
  return _internal_avatar();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerOfflineNotify::set_avatar(ArgT0&& arg0, ArgT... args) {
 
 avatar_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOfflineNotify.avatar)
}
inline std::string* PlayerOfflineNotify::mutable_avatar() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOfflineNotify.avatar)
  return _internal_mutable_avatar();
}
inline const std::string& PlayerOfflineNotify::_internal_avatar() const {
  return avatar_.Get();
}
inline void PlayerOfflineNotify::_internal_set_avatar(const std::string& value) {
  
  avatar_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::_internal_mutable_avatar() {
  
  return avatar_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::release_avatar() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOfflineNotify.avatar)
  return avatar_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerOfflineNotify::set_allocated_avatar(std::string* avatar) {
  if (avatar != nullptr) {
  ...
  avatar_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), avatar,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOfflineNotify.avatar)
}

// bytes avatar_frame = 9;
inline void PlayerOfflineNotify::clear_avatar_frame() {
  avatar_frame_.ClearToEmpty();
}
inline const std::string& PlayerOfflineNotify::avatar_frame() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.avatar_frame)
  return _internal_avatar_frame();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PlayerOfflineNotify::set_avatar_frame(ArgT0&& arg0, ArgT... args) {
 
 avatar_frame_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOfflineNotify.avatar_frame)
}
inline std::string* PlayerOfflineNotify::mutable_avatar_frame() {
  // @@protoc_insertion_point(field_mutable:KWMsg.PlayerOfflineNotify.avatar_frame)
  return _internal_mutable_avatar_frame();
}
inline const std::string& PlayerOfflineNotify::_internal_avatar_frame() const {
  return avatar_frame_.Get();
}
inline void PlayerOfflineNotify::_internal_set_avatar_frame(const std::string& value) {
  
  avatar_frame_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::_internal_mutable_avatar_frame() {
  
  return avatar_frame_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PlayerOfflineNotify::release_avatar_frame() {
  // @@protoc_insertion_point(field_release:KWMsg.PlayerOfflineNotify.avatar_frame)
  return avatar_frame_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PlayerOfflineNotify::set_allocated_avatar_frame(std::string* avatar_frame) {
  if (avatar_frame != nullptr) {
  ...
  avatar_frame_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), avatar_frame,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:KWMsg.PlayerOfflineNotify.avatar_frame)
}

// int32 level = 10;
inline void PlayerOfflineNotify::clear_level() {
  level_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOfflineNotify::_internal_level() const {
  return level_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PlayerOfflineNotify::level() const {
  // @@protoc_insertion_point(field_get:KWMsg.PlayerOfflineNotify.level)
  return _internal_level();
}
inline void PlayerOfflineNotify::_internal_set_level(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  level_ = value;
}
inline void PlayerOfflineNotify::set_level(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_level(value);
  // @@protoc_insertion_point(field_set:KWMsg.PlayerOfflineNotify.level)
}
