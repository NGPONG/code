...
#include <memory>
#include "../signal_slot/mysignal.h"
...
QT_MOC_LITERAL(1, 9, 8), // "initiate"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "MySignal\0initiate\0"
};
...
void MySignal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MySignal *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->initiate(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MySignal::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySignal::initiate)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MySignal::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MySignal.data,
    qt_meta_data_MySignal,
    qt_static_metacall,
    nullptr,
    nullptr
} };
