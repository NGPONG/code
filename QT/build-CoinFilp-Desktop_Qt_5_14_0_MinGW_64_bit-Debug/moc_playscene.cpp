...
QT_MOC_LITERAL(3, 18, 10), // "PlayScene*"
QT_MOC_LITERAL(4, 29, 2) // "_p"

    },
    "PlayScene\0closed\0\0PlayScene*\0_p"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closed((*reinterpret_cast< PlayScene*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< PlayScene* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (PlayScene::*)(PlayScene * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::closed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayScene::closed(PlayScene * _t1)
{
