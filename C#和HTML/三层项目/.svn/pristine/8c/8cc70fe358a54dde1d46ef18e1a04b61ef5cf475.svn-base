namespace WP.Demo.UI
{
    partial class frmOrderDish
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmOrderDish";
            this.ShowIcon = false;
            this.Text = "点菜";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmOrderDish_FormClosing);
            this.Load += new System.EventHandler(this.frmOrderDish_Load);
